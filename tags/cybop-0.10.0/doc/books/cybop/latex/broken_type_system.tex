...
\index{Broken Type System in Java}
\index{Reflective Mechanisms and their Negative Effects}
\index{Java Class Framework}
\index{Smalltalk}
...
\index{JVM}
\index{Bidirectional Dependency in Java Class Framework}
\index{Circular Reference in Java Class Framework}
\index{Redundant Meta Information in Java Class Framework}
\index{Wrapper Classes in Java}
\index{Super Platform}
\index{Sub Platform}
\index{Java Native Interface}
\index{JNI}
\index{Pre-Conditions in JVM}
\index{Internal Meta Class in JVM}
\index{Primordial Class Loader in JVM}
...
\begin{figure}[ht]
    \begin{center}
        \includegraphics[scale=0.3,angle=-90]{graphic/typesystem.pdf}
