...
#ifndef AUTHORITY_FORM_HTTP_REQUEST_URI_SELECTOR_SOURCE
#define AUTHORITY_FORM_HTTP_REQUEST_URI_SELECTOR_SOURCE
 ...
 */
void select_authority_form_http_request_uri(void* p0, void* p1, void* p2, void* p3, void* p4, void* p5, void* p6, void* p7, void* p8) {

    if (p6 != *NULL_POINTER_MEMORY_MODEL) {

        int* b = (int*) p6;

        log_terminated_message((void*) DEBUG_LEVEL_LOG_MODEL, (void*) L"Select authority form http request uri.");
        ...
        if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
            ...
            detect((void*) &r, p7, p8, (void*) AUTHORITY_FORM_HTTP_REQUEST_URI_NAME, (void*) AUTHORITY_FORM_HTTP_REQUEST_URI_NAME_COUNT, (void*) WIDE_CHARACTER_MEMORY_ABSTRACTION, (void*) WIDE_CHARACTER_MEMORY_ABSTRACTION_COUNT, (void*) NUMBER_0_INTEGER_MEMORY_MODEL);
        ...
        log_terminated_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) L"Could not select authority form http request uri. The break flag is null.");
    }
}

/* AUTHORITY_FORM_HTTP_REQUEST_URI_SELECTOR_SOURCE */
#endif
