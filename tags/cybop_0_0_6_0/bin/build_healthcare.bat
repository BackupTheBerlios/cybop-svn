...
rem
rem $RCSfile: build_healthcare.bat,v $
rem
...
rem
java -mx64m -classpath %CLASSPATH% -Dant.home=%RESMEDICINAE_HOME%\lib org.apache.tools.ant.Main -buildfile %RESMEDICINAE_HOME%\bin\domain\healthcare\build.xml %*%
