...
#
java -mx64m -classpath ${CLASSPATH} -Dant.home=${CYBOP_HOME}/lib org.apache.tools.ant.Main "${*}" -buildfile ${CYBOP_HOME}/src/build_healthcare.xml
