...
#
# $RCSfile: set_build_classpath.sh,v $
#
...
#
# This file sets the classpaths for execution from the build.
#
...
BUILD_CLASSPATH=${CYBOP_HOME}/build/cyboi:${CYBOP_HOME}/build/core:
export BUILD_CLASSPATH

CLASSPATH=${CLASSPATH}:${EXTERNAL_CLASSPATH}:${BUILD_CLASSPATH}
export CLASSPATH
