...
#ifndef DOUBLE_VECTOR_REMOVER_SOURCE
#define DOUBLE_VECTOR_REMOVER_SOURCE
...
void remove_double_vector_element(void* p0, void* p1, void* p2) {
    ...
    remove_array_elements(p0, p1, p2, (void*) NUMBER_1_INTEGER_MEMORY_MODEL, (void*) DOUBLE_MEMORY_ABSTRACTION);
}

/* DOUBLE_VECTOR_REMOVER_SOURCE */
#endif
