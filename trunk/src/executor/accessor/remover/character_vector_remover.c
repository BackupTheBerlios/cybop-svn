...
#ifndef CHARACTER_VECTOR_REMOVER_SOURCE
#define CHARACTER_VECTOR_REMOVER_SOURCE
...
void remove_character_vector_element(void* p0, void* p1, void* p2) {
    ...
    remove_array_elements(p0, p1, p2, (void*) NUMBER_1_INTEGER_MEMORY_MODEL, (void*) CHARACTER_MEMORY_ABSTRACTION);
}

/* CHARACTER_VECTOR_REMOVER_SOURCE */
#endif
