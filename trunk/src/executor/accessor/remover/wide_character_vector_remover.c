...
#ifndef WIDE_CHARACTER_VECTOR_REMOVER_SOURCE
#define WIDE_CHARACTER_VECTOR_REMOVER_SOURCE
...
void remove_wide_character_vector_element(void* p0, void* p1, void* p2) {
    ...
    remove_array_elements(p0, p1, p2, (void*) NUMBER_1_INTEGER_MEMORY_MODEL, (void*) WIDE_CHARACTER_MEMORY_ABSTRACTION);
}

/* WIDE_CHARACTER_VECTOR_REMOVER_SOURCE */
#endif
