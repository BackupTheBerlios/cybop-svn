...
#ifndef INTEGER_VECTOR_SETTER_SOURCE
#define INTEGER_VECTOR_SETTER_SOURCE
...
void set_integer_vector_element(void* p0, void* p1, void* p2) {
    ...
    set_array_elements(p0, p1, p2, (void*) NUMBER_1_INTEGER_MEMORY_MODEL, (void*) INTEGER_MEMORY_ABSTRACTION);
}

/* INTEGER_VECTOR_SETTER_SOURCE */
#endif
