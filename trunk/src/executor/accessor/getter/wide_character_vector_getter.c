...
#ifndef WIDE_CHARACTER_VECTOR_GETTER_SOURCE
#define WIDE_CHARACTER_VECTOR_GETTER_SOURCE
...
void get_wide_character_vector_element(void* p0, void* p1, void* p2) {
    ...
    get_array_elements(p0, p1, p2, (void*) WIDE_CHARACTER_MEMORY_ABSTRACTION);
}

/* WIDE_CHARACTER_VECTOR_GETTER_SOURCE */
#endif
