...
#ifndef CHARACTER_VECTOR_GETTER_SOURCE
#define CHARACTER_VECTOR_GETTER_SOURCE
...
void get_character_vector_element(void* p0, void* p1, void* p2) {
    ...
    get_array_elements(p0, p1, p2, (void*) CHARACTER_MEMORY_ABSTRACTION);
}

/* CHARACTER_VECTOR_GETTER_SOURCE */
#endif
