...
#ifndef DOUBLE_VECTOR_GETTER_SOURCE
#define DOUBLE_VECTOR_GETTER_SOURCE
...
void get_double_vector_element(void* p0, void* p1, void* p2) {
    ...
    get_array_elements(p0, p1, p2, (void*) DOUBLE_MEMORY_ABSTRACTION);
}

/* DOUBLE_VECTOR_GETTER_SOURCE */
#endif
