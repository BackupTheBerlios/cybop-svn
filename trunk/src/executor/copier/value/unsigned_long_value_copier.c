...
#ifndef UNSIGNED_LONG_VALUE_COPIER_SOURCE
#define UNSIGNED_LONG_VALUE_COPIER_SOURCE
 ...
 */
void copy_value_unsigned_long(void* p0, void* p1) {
...
/* UNSIGNED_LONG_VALUE_COPIER_SOURCE */
#endif
