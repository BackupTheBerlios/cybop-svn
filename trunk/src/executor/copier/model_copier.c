...
#ifndef MODEL_COPIER_SOURCE
#define MODEL_COPIER_SOURCE
...
/**
 * Copies the source model models to the destination model deep.
 *
 ...
 */
void copy_model_models_deep(void* p0, void* p1, void* p2, void* p3, void* p4) {

    if (p4 != *NULL_POINTER_MEMORY_MODEL) {

        int* sc = (int*) p4;

        log_terminated_message((void*) DEBUG_LEVEL_LOG_MODEL, (void*) L"Copy model models deep.");
        ...
        while (*NUMBER_1_INTEGER_MEMORY_MODEL) {
            ...
            if (sp != *NULL_POINTER_MEMORY_MODEL) {
                ...
                log_terminated_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) L"Could not copy model models deep. The source part model is null.");
            }
        ...
        log_terminated_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) L"Could not copy model models deep. The source count is null.");
    }
}

/**
 * Copies the source model models to the destination model at position index.
 *
 * @param p0 the destination model
 * @param p1 the source model
 ...
 */
void copy_model_models(void* p0, void* p1, void* p2, void* p3, void* p4, void* p5) {

    if (p2 != *NULL_POINTER_MEMORY_MODEL) {

        int* a = (int*) p2;

        log_terminated_message((void*) DEBUG_LEVEL_LOG_MODEL, (void*) L"Copy model models.");
        ...
        log_terminated_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) L"Could not copy model models. The operand abstraction is null.");
    }
}

/**
 * Copies the source model to the destination model at position index.
 *
 ...
 */
void copy_model(void* p0, void* p1, void* p2, void* p3, void* p4) {

    log_terminated_message((void*) DEBUG_LEVEL_LOG_MODEL, (void*) L"Copy model.");
    ...
    if (ar != *NUMBER_0_INTEGER_MEMORY_MODEL) {
        ...
        log_terminated_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) L"Could not copy model. The destination- and source abstractions are not equal.");
    }
}
