...
#ifndef COMPOUND_COPIER_SOURCE
#define COMPOUND_COPIER_SOURCE
...
/**
 * Copies the source part to the destination compound at position index.
 *
 ...
 */
void copy_compound_part(void* p0, void* p1, void* p2) {

    log_terminated_message((void*) DEBUG_LEVEL_LOG_MODEL, (void*) L"Copy compound part.");
