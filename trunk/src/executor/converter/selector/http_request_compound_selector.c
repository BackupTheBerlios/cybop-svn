...
void decode_http_request_compound_uri(void* p0, void* p1, void* p2, void* p3, void* p4, void* p5, void* p6) {
    ...
    if (p4 != *NULL_POINTER_MEMORY_MODEL) {
        ...
        // Get separator index.
        get_array_elements_index((void*) &sep, i, (void*) &ic, (void*) SCHEME_SEPARATOR_URI_MODEL, (void*) SCHEME_SEPARATOR_URI_MODEL_COUNT, (void*) WIDE_CHARACTER_PRIMITIVE_MEMORY_ABSTRACTION);
    ...
    fwprintf(stdout, L"TEST http request uri schc: %i \n", schc);
        ...
        // Get separator index.
        get_array_elements_index((void*) &sep, i, (void*) &ic, (void*) AUTHORITY_SEPARATOR_URI_MODEL, (void*) AUTHORITY_SEPARATOR_URI_MODEL_COUNT, (void*) WIDE_CHARACTER_PRIMITIVE_MEMORY_ABSTRACTION);
        ...
        if (sep >= *NUMBER_0_INTEGER_MEMORY_MODEL) {
            ...
            // Get separator index.
            get_array_elements_index((void*) &sep, i, (void*) &ic, (void*) PATH_SEPARATOR_URI_MODEL, (void*) PATH_SEPARATOR_URI_MODEL_COUNT, (void*) WIDE_CHARACTER_PRIMITIVE_MEMORY_ABSTRACTION);
            ...
            if (sep >= *NUMBER_0_INTEGER_MEMORY_MODEL) {
                ...
                // Get separator index.
                get_array_elements_index((void*) &sep, i, (void*) &ic, (void*) QUERY_SEPARATOR_URI_MODEL, (void*) QUERY_SEPARATOR_URI_MODEL_COUNT, (void*) WIDE_CHARACTER_PRIMITIVE_MEMORY_ABSTRACTION);
                ...
                if (sep >= *NUMBER_0_INTEGER_MEMORY_MODEL) {
                    ...
                    // Get separator index.
                    get_array_elements_index((void*) &sep, i, (void*) &ic, (void*) FRAGMENT_SEPARATOR_URI_MODEL, (void*) FRAGMENT_SEPARATOR_URI_MODEL_COUNT, (void*) WIDE_CHARACTER_PRIMITIVE_MEMORY_ABSTRACTION);
