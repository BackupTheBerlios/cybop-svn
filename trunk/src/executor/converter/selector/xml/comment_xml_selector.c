        ...
        if (p1 != *NULL_POINTER_MEMORY_MODEL) {
            ...
            if (p0 != *NULL_POINTER_MEMORY_MODEL) {
                ...
                if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
                    ...
                    detect_array((void*) &r, p1, p2, (void*) COMMENT_END_XML_NAME, (void*) WIDE_CHARACTER_PRIMITIVE_MEMORY_ABSTRACTION, (void*) COMMENT_END_XML_NAME_COUNT, (void*) NUMBER_1_INTEGER_MEMORY_MODEL);
