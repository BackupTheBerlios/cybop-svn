 ...
 */
void select_absolute_path_http_request_uri(void* p0, void* p1, void* p2, void* p3, void* p4, void* p5, void* p6, void* p7, void* p8) {
    ...
    if (p6 != *NULL_POINTER_MEMORY_MODEL) {
        ...
        log_terminated_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) L"Could not select absolute path http request uri. The break flag is null.");
    }
}
