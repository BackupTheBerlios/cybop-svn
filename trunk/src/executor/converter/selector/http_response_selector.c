...
void encode_http_response_status_line(void* p0, void* p1, void* p2, void* p3, void* p4) {
    ...
    encode(p0, p1, p2, *NULL_POINTER_MEMORY_MODEL, *NULL_POINTER_MEMORY_MODEL, *NULL_POINTER_MEMORY_MODEL, *NULL_POINTER_MEMORY_MODEL,
        ...
        *NULL_POINTER_MEMORY_MODEL, *NULL_POINTER_MEMORY_MODEL, (void*) WIDE_CHARACTER_MEMORY_ABSTRACTION, (void*) WIDE_CHARACTER_MEMORY_ABSTRACTION_COUNT);
    ...
    if (p2 != *NULL_POINTER_MEMORY_MODEL) {
        ...
        if (p1 != *NULL_POINTER_MEMORY_MODEL) {
            ...
            if (p0 != *NULL_POINTER_MEMORY_MODEL) {
                ...
                allocate_array((void*) &b, (void*) &bs, (void*) WIDE_CHARACTER_MEMORY_ABSTRACTION, (void*) WIDE_CHARACTER_MEMORY_ABSTRACTION_COUNT);
                ...
                if ((*dc + bc) > *ds) {
                    ...
                    *ds = *dc + bc;
                    ...
                    reallocate_array(p0, p1, p2, (void*) WIDE_CHARACTER_MEMORY_ABSTRACTION, (void*) WIDE_CHARACTER_MEMORY_ABSTRACTION_COUNT);
                }

                // Copy temporary body to the end of the actual destination http response.
                set_array_elements(*d, b, (void*) &bc, p1, (void*) WIDE_CHARACTER_MEMORY_ABSTRACTION, (void*) WIDE_CHARACTER_MEMORY_ABSTRACTION_COUNT);

                // Increase destination http response count by the body count.
                *dc = *dc + bc;

                // Deallocate temporary body.
                deallocate_array((void*) &b, (void*) &bs, (void*) WIDE_CHARACTER_MEMORY_ABSTRACTION, (void*) WIDE_CHARACTER_MEMORY_ABSTRACTION_COUNT);
