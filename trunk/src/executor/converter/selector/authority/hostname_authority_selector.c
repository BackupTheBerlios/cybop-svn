 ...
 */
void select_authority_hostname(void* p0, void* p1, void* p2, void* p3, void* p4, void* p5, void* p6, void* p7, void* p8) {

    if (p6 != *NULL_POINTER_MEMORY_MODEL) {

        int* b = (int*) p6;

        log_terminated_message((void*) DEBUG_LEVEL_LOG_MODEL, (void*) L"Select authority hostname.");
        ...
        if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
            ...
            if (r != *NUMBER_0_INTEGER_MEMORY_MODEL) {
                ...
                decode_authority_port(p0, p1, p2, p3, p4, p5, p7, p8);
        ...
        log_terminated_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) L"Could not select authority hostname. The break flag is null.");
    }
}

/* HOSTNAME_AUTHORITY_SELECTOR_SOURCE */
#endif
