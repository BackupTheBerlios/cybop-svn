 ...
 */
void decode_authority_port(void* p0, void* p1, void* p2, void* p3, void* p4, void* p5, void* p6, void* p7) {
    ...
    if (p7 != *NULL_POINTER_MEMORY_MODEL) {
        ...
        if (p6 != *NULL_POINTER_MEMORY_MODEL) {
            ...
            log_terminated_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) L"Could not decode authority port. The current position is null.");
        }

    } else {

        log_terminated_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) L"Could not decode authority port. The remaining count is null.");
    }
}
