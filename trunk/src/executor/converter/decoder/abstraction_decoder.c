...
void decode_abstraction(void* p0, void* p1, void* p2, void* p3, void* p4) {
    ...
    if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
        ...
        if (r != *NUMBER_0_INTEGER_MEMORY_MODEL) {
            ...
            set(p0, p1, p2, (void*) INTEGER_MEMORY_ABSTRACTION, (void*) INTEGER_MEMORY_ABSTRACTION_COUNT, (void*) NUMBER_0_INTEGER_MEMORY_MODEL, (void*) WIDE_CHARACTER_MEMORY_ABSTRACTION, (void*) WIDE_CHARACTER_MEMORY_ABSTRACTION_COUNT);
        }
    }
    ...
    if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
        ...
        if (r != *NUMBER_0_INTEGER_MEMORY_MODEL) {
            ...
            set(p0, p1, p2, (void*) COMPLEX_MEMORY_ABSTRACTION, (void*) COMPLEX_MEMORY_ABSTRACTION_COUNT, (void*) NUMBER_0_INTEGER_MEMORY_MODEL, (void*) WIDE_CHARACTER_MEMORY_ABSTRACTION, (void*) WIDE_CHARACTER_MEMORY_ABSTRACTION_COUNT);
        }
    }
    ...
    if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
        ...
        if (r != *NUMBER_0_INTEGER_MEMORY_MODEL) {
            ...
            set(p0, p1, p2, (void*) COMPOUND_MEMORY_ABSTRACTION, (void*) COMPOUND_MEMORY_ABSTRACTION_COUNT, (void*) NUMBER_0_INTEGER_MEMORY_MODEL, (void*) WIDE_CHARACTER_MEMORY_ABSTRACTION, (void*) WIDE_CHARACTER_MEMORY_ABSTRACTION_COUNT);
        }
    }
    ...
    if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
        ...
        if (r != *NUMBER_0_INTEGER_MEMORY_MODEL) {
            ...
            set(p0, p1, p2, (void*) FRACTION_MEMORY_ABSTRACTION, (void*) FRACTION_MEMORY_ABSTRACTION_COUNT, (void*) NUMBER_0_INTEGER_MEMORY_MODEL, (void*) WIDE_CHARACTER_MEMORY_ABSTRACTION, (void*) WIDE_CHARACTER_MEMORY_ABSTRACTION_COUNT);
        }
    }
    ...
    if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
        ...
        if (r != *NUMBER_0_INTEGER_MEMORY_MODEL) {
            ...
            set(p0, p1, p2, (void*) ENCAPSULATED_KNOWLEDGE_PATH_MEMORY_ABSTRACTION, (void*) ENCAPSULATED_KNOWLEDGE_PATH_MEMORY_ABSTRACTION_COUNT, (void*) NUMBER_0_INTEGER_MEMORY_MODEL, (void*) WIDE_CHARACTER_MEMORY_ABSTRACTION, (void*) WIDE_CHARACTER_MEMORY_ABSTRACTION_COUNT);
        }
    }
    ...
    if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
        ...
        if (r != *NUMBER_0_INTEGER_MEMORY_MODEL) {
            ...
            set(p0, p1, p2, (void*) DATETIME_MEMORY_ABSTRACTION, (void*) DATETIME_MEMORY_ABSTRACTION_COUNT, (void*) NUMBER_0_INTEGER_MEMORY_MODEL, (void*) WIDE_CHARACTER_MEMORY_ABSTRACTION, (void*) WIDE_CHARACTER_MEMORY_ABSTRACTION_COUNT);
        }
    }
    ...
    if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
        ...
        if (r != *NUMBER_0_INTEGER_MEMORY_MODEL) {
            ...
            set(p0, p1, p2, (void*) KNOWLEDGE_PATH_MEMORY_ABSTRACTION, (void*) KNOWLEDGE_PATH_MEMORY_ABSTRACTION_COUNT, (void*) NUMBER_0_INTEGER_MEMORY_MODEL, (void*) WIDE_CHARACTER_MEMORY_ABSTRACTION, (void*) WIDE_CHARACTER_MEMORY_ABSTRACTION_COUNT);
        }
    }
    ...
    if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
        ...
        if (r != *NUMBER_0_INTEGER_MEMORY_MODEL) {
            ...
            set(p0, p1, p2, (void*) OPERATION_MEMORY_ABSTRACTION, (void*) OPERATION_MEMORY_ABSTRACTION_COUNT, (void*) NUMBER_0_INTEGER_MEMORY_MODEL, (void*) WIDE_CHARACTER_MEMORY_ABSTRACTION, (void*) WIDE_CHARACTER_MEMORY_ABSTRACTION_COUNT);
        }
    }
    ...
    if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
        ...
        if (r != *NUMBER_0_INTEGER_MEMORY_MODEL) {
            ...
            set(p0, p1, p2, (void*) WIDE_CHARACTER_MEMORY_ABSTRACTION, (void*) WIDE_CHARACTER_MEMORY_ABSTRACTION_COUNT, (void*) NUMBER_0_INTEGER_MEMORY_MODEL, (void*) WIDE_CHARACTER_MEMORY_ABSTRACTION, (void*) WIDE_CHARACTER_MEMORY_ABSTRACTION_COUNT);
        }
    }
