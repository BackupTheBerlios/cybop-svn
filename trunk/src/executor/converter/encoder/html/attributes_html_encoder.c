...
void encode_html_attribute(void* p0, void* p1, void* p2, void* p3, void* p4, void* p5) {
    ...
    compare_equal_arrays((void*) &r, *n, *nc, (void*) TAG_WEB_USER_INTERFACE_CYBOL_NAME, (void*) TAG_WEB_USER_INTERFACE_CYBOL_NAME_COUNT, (void*) WIDE_CHARACTER_PRIMITIVE_MEMORY_ABSTRACTION);
    ...
    if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
        ...
        append_array_elements(p0, p1, p2, *n, *nc, (void*) WIDE_CHARACTER_PRIMITIVE_MEMORY_ABSTRACTION);
        // Encode equals sign character.
        append_array_elements(p0, p1, p2, (void*) EQUALS_SIGN_UNICODE_CHARACTER_CODE_MODEL, (void*) PRIMITIVE_MEMORY_MODEL_COUNT, (void*) WIDE_CHARACTER_PRIMITIVE_MEMORY_ABSTRACTION);
        // Encode quotation mark character.
        append_array_elements(p0, p1, p2, (void*) QUOTATION_MARK_UNICODE_CHARACTER_CODE_MODEL, (void*) PRIMITIVE_MEMORY_MODEL_COUNT, (void*) WIDE_CHARACTER_PRIMITIVE_MEMORY_ABSTRACTION);
        // Encode space character.
        append_array_elements(p0, p1, p2, *m, *mc, (void*) WIDE_CHARACTER_PRIMITIVE_MEMORY_ABSTRACTION);
        // Encode quotation mark character.
        append_array_elements(p0, p1, p2, (void*) QUOTATION_MARK_UNICODE_CHARACTER_CODE_MODEL, (void*) PRIMITIVE_MEMORY_MODEL_COUNT, (void*) WIDE_CHARACTER_PRIMITIVE_MEMORY_ABSTRACTION);
    }
}
