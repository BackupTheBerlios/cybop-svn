...
#ifndef FRACTION_FRACTION_DIVIDER_SOURCE
#define FRACTION_FRACTION_DIVIDER_SOURCE
 ...
 */
void divide_fraction_by_fraction(void* p0, void* p1) {

    log_terminated_message((void*) DEBUG_LEVEL_LOG_MODEL, (void*) L"Divide fraction by fraction.");
    ...
    multiply_integer(*dd, *sn, (void*) INTEGER_PRIMITIVE_MEMORY_ABSTRACTION);

    reduce_fraction(p0);
}

/* FRACTION_FRACTION_DIVIDER_SOURCE */
#endif
