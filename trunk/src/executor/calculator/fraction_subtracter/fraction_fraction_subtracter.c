...
#ifndef FRACTION_FRACTION_SUBTRACTER_SOURCE
#define FRACTION_FRACTION_SUBTRACTER_SOURCE
...
void add_fraction_to_fraction(void* p0, void* p1) {
    ...
    log_terminated_message((void*) DEBUG_LEVEL_LOG_MODEL, (void*) L"Subtract fraction from fraction.");
    ...
    subtract_integer(*dn, *sn, (void*) INTEGER_PRIMITIVE_MEMORY_ABSTRACTION);
    multiply_integer(*dd, *sd, (void*) INTEGER_PRIMITIVE_MEMORY_ABSTRACTION);

    reduce_fraction(p0);
}

/* FRACTION_FRACTION_SUBTRACTER_SOURCE */
#endif
