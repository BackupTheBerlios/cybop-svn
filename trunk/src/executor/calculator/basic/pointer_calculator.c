...
void calculate_pointer(void* p0, void* p1, void* p2) {
    ...
    log_terminated_message((void*) DEBUG_LEVEL_LOG_MODEL, (void*) L"Calculate pointer.");
...
*/
    ...
    if (r == *FALSE_BOOLEAN_MEMORY_MODEL) {
        ...
        log_terminated_message((void*) WARNING_LEVEL_LOG_MODEL, (void*) L"Could not calculate pointer. The operation abstraction is unknown.");
    }
}
