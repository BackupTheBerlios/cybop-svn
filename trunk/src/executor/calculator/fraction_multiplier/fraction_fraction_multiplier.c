...
#ifndef FRACTION_FRACTION_MULTIPLIER_SOURCE
#define FRACTION_FRACTION_MULTIPLIER_SOURCE
...
void add_fraction_to_fraction(void* p0, void* p1) {
    ...
    log_terminated_message((void*) DEBUG_LEVEL_LOG_MODEL, (void*) L"Multiply fraction with fraction.");
    ...
    multiply_integer(*dn, *sn, (void*) INTEGER_PRIMITIVE_MEMORY_ABSTRACTION);
    multiply_integer(*dd, *sd, (void*) INTEGER_PRIMITIVE_MEMORY_ABSTRACTION);

    reduce_fraction(p0);
}

/* FRACTION_FRACTION_MULTIPLIER_SOURCE */
#endif
