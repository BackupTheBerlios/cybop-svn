...
#ifndef MULTIPLIER_SOURCE
#define MULTIPLIER_SOURCE
 ...
 *
 * CAUTION! This function works ONLY if the destination is of
 * type INTEGER (as well as the source), since it (the destination)
 * is repeatedly added below.
 *
 * @param p0 the destination
 * @param p1 the source factor 1
 * @param p2 the source factor 2
 */
void multiply_integer_with_integer(void* p0, void* p1, void* p2) {
    ...
    if (p2 != *NULL_POINTER_MEMORY_MODEL) {
        ...
        if (p1 != *NULL_POINTER_MEMORY_MODEL) {
            ...
            if (p0 != *NULL_POINTER_MEMORY_MODEL) {
                ...
                //?? is used here, instead of looping and adding values manually,
...
*/
            ...
            log_terminated_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) L"Could not multiply integer with integer. The source factor 1 is null.");
        }

    } else {

        log_terminated_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) L"Could not multiply integer with integer. The source factor 2 is null.");
    }
}
