...
fwprintf(stdout, L"TEST compound deallocator n: %i\n", n);
fwprintf(stdout, L"TEST compound deallocator *n: %i\n", *n);
fwprintf(stdout, L"TEST compound deallocator *n: %ls\n", (wchar_t*) *n);
