 ...
 *
 * @version $RCSfile: integer_vector_allocator.c,v $ $Revision: 1.11 $ $Date: 2009-01-31 16:06:33 $ $Author: christian $
 * @author Christian Heller <christian.heller@tuxtax.de>
 */

#ifndef INTEGER_VECTOR_DEALLOCATOR_SOURCE
#define INTEGER_VECTOR_DEALLOCATOR_SOURCE
