...
#ifndef ITEM_SUBSEQUENCE_COMPARATOR_SOURCE
#define ITEM_SUBSEQUENCE_COMPARATOR_SOURCE
...
/**
 * Compares if the right array is a subsequence of the left item.
 *
 ...
 */
void compare_subsequence_item_element(void* p0, void* p1, void* p2, void* p3, void* p4, void* p5, void* p6) {

    log_terminated_message((void*) INFORMATION_LEVEL_LOG_MODEL, (void*) L"Compare subsequence item element.");
    ...
    if (r != *NUMBER_0_INTEGER_MEMORY_MODEL) {
        ...
        // Compare if the right array is a subsequence of the left item data array.
        compare_subsequence_array(p0, e, p2, p3, p4, c, p5);
        ...
        // Compare if the right array is a subsequence of the left item data array.
        compare_subsequence_array(p0, e, p2, p3, p4, (void*) PRIMITIVE_MEMORY_MODEL_COUNT, (void*) PRIMITIVE_MEMORY_MODEL_COUNT);
    }
}

/**
 * Compares if the right- is a subsequence of the left item.
 *
 * @param p0 the result (number 1 if true; unchanged otherwise)
 * @param p1 the left item
 ...
 * @param p4 the operand abstraction
 */
void compare_subsequence_item(void* p0, void* p1, void* p2, void* p3, void* p4) {

    log_terminated_message((void*) INFORMATION_LEVEL_LOG_MODEL, (void*) L"Compare subsequence item.");
    ...
    // Compare if the right- is a subsequence of the left item data array.
    compare_subsequence_array(p0, ld, rd, p3, p4, lc, rc);
}

/* ITEM_SUBSEQUENCE_COMPARATOR_SOURCE */
#endif
