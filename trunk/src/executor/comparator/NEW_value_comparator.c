 ...
 * @param p4 the operand abstraction count
 * @param p5 the operation abstraction
 * @param p6 the operation abstraction count
 */
void compare_value(void* p0, void* p1, void* p2, void* p3, void* p4, void* p5, void* p6) {
    ...
    if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
        ...
        if (r != *NUMBER_0_INTEGER_MEMORY_MODEL) {
            ...
            compare_value_character(p0, p1, p2, p5, p6);
        }
    }
    ...
    if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
        ...
        log_terminated_message((void*) WARNING_LEVEL_LOG_MODEL, (void*) L"Could not compare value. The abstraction is unknown.");
    }
}
