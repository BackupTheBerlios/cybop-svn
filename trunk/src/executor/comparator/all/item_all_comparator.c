...
/**
 * Compares all elements of the left item with those of the right array.
 *
...
/**
 * Compares all elements of the left- with those of the right item.
 *
 * @param p0 the result (number 1 if true; unchanged otherwise)
 * @param p1 the left item
