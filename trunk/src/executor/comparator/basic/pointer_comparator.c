...
void compare_pointer(void* p0, void* p1, void* p2, void* p3) {
    ...
    if (p3 != *NULL_POINTER_MEMORY_MODEL) {
            ...
            if (p1 != *NULL_POINTER_MEMORY_MODEL) {
                ...
                if (p0 != *NULL_POINTER_MEMORY_MODEL) {
                    ...
                    if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
                        ...
                        log_terminated_message((void*) WARNING_LEVEL_LOG_MODEL, (void*) L"Could not compare pointer. The operation abstraction is unknown.");
                    }
        ...
        log_terminated_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) L"Could not compare pointer. The operation abstraction is null.");
    }
}
