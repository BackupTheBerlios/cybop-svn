        ...
        if (p2 != *NULL_POINTER_MEMORY_MODEL) {
            ...
            if (p1 != *NULL_POINTER_MEMORY_MODEL) {
                ...
                if (p0 != *NULL_POINTER_MEMORY_MODEL) {
                    ...
                    log_terminated_message((void*) DEBUG_LEVEL_LOG_MODEL, (void*) L"Compare double.");
                    ...
                    if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
                        ...
                        log_terminated_message((void*) WARNING_LEVEL_LOG_MODEL, (void*) L"Could not compare double. The operation abstraction is unknown.");
                    }

                } else {

                    log_terminated_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) L"Could not compare double. The result is null.");
                }

            } else {

                log_terminated_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) L"Could not compare double. The left value is null.");
            }

        } else {

            log_terminated_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) L"Could not compare double. The right value is null.");
        }

    } else {

        log_terminated_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) L"Could not compare double. The operation abstraction is null.");
    }
}
