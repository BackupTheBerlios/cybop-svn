        ...
        if (p2 != *NULL_POINTER_MEMORY_MODEL) {
            ...
            if (p1 != *NULL_POINTER_MEMORY_MODEL) {
                ...
                if (p0 != *NULL_POINTER_MEMORY_MODEL) {
                    ...
                    log_terminated_message((void*) DEBUG_LEVEL_LOG_MODEL, (void*) L"Compare wide character.");
                    ...
                    if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
                        ...
                        log_terminated_message((void*) WARNING_LEVEL_LOG_MODEL, (void*) L"Could not compare wide character. The operation abstraction is unknown.");
                    }

                } else {

                    log_terminated_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) L"Could not compare wide character. The result is null.");
                }

            } else {

                log_terminated_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) L"Could not compare wide character. The left value is null.");
            }

        } else {

            log_terminated_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) L"Could not compare wide character. The right value is null.");
        }

    } else {

        log_terminated_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) L"Could not compare wide character. The operation abstraction is null.");
    }
}
