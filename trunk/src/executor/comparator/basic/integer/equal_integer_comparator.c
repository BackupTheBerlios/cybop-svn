...
void compare_integer_equal(void* p0, void* p1, void* p2) {
    ...
    if (p2 != *NULL_POINTER_MEMORY_MODEL) {
        ...
        if (p1 != *NULL_POINTER_MEMORY_MODEL) {
            ...
            log_terminated_message((void*) DEBUG_LEVEL_LOG_MODEL, (void*) L"Compare integer equal.");
            ...
            log_terminated_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) L"Could not compare integer equal. The left value is null.");
        }

    } else {

        log_terminated_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) L"Could not compare integer equal. The right value is null.");
    }
}
