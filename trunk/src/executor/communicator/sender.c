...
/*??
        compare_all_array((void*) &r, p5, p6, (void*) DATAGRAM_COMMUNICATION_STYLE_CYBOL_MODEL, (void*) DATAGRAM_COMMUNICATION_STYLE_CYBOL_MODEL_COUNT, (void*) EQUAL_PRIMITIVE_OPERATION_ABSTRACTION, (void*) WIDE_CHARACTER_PRIMITIVE_MEMORY_ABSTRACTION);
...
*/
    ...
    if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
        ...
        compare_all_array((void*) &r, p5, p6, (void*) FILE_SYSTEM_CYBOL_CHANNEL, (void*) FILE_SYSTEM_CYBOL_CHANNEL_COUNT, (void*) EQUAL_PRIMITIVE_OPERATION_ABSTRACTION, (void*) WIDE_CHARACTER_PRIMITIVE_MEMORY_ABSTRACTION);
    ...
    if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
        ...
        compare_all_array((void*) &r, p5, p6, (void*) GNU_LINUX_CONSOLE_CYBOL_CHANNEL, (void*) GNU_LINUX_CONSOLE_CYBOL_CHANNEL_COUNT, (void*) EQUAL_PRIMITIVE_OPERATION_ABSTRACTION, (void*) WIDE_CHARACTER_PRIMITIVE_MEMORY_ABSTRACTION);
    ...
    if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
        ...
        compare_all_array((void*) &r, p5, (void*) INLINE_CYBOL_CHANNEL, (void*) EQUAL_PRIMITIVE_OPERATION_ABSTRACTION, (void*) WIDE_CHARACTER_PRIMITIVE_MEMORY_ABSTRACTION, p6, (void*) INLINE_CYBOL_CHANNEL_COUNT);
...
/*??
        compare_all_array((void*) &r, p5, (void*) RAW_COMMUNICATION_STYLE_CYBOL_MODEL, (void*) EQUAL_PRIMITIVE_OPERATION_ABSTRACTION, (void*) WIDE_CHARACTER_PRIMITIVE_MEMORY_ABSTRACTION, p6, (void*) RAW_COMMUNICATION_STYLE_CYBOL_MODEL_COUNT);
...
*/
    ...
    if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
        ...
        compare_all_array((void*) &r, p5, (void*) SHELL_CYBOL_CHANNEL, (void*) EQUAL_PRIMITIVE_OPERATION_ABSTRACTION, (void*) WIDE_CHARACTER_PRIMITIVE_MEMORY_ABSTRACTION, p6, (void*) SHELL_CYBOL_CHANNEL_COUNT);
...
/*??
        compare_all_array((void*) &r, p5, (void*) STREAM_COMMUNICATION_STYLE_CYBOL_MODEL, (void*) EQUAL_PRIMITIVE_OPERATION_ABSTRACTION, (void*) WIDE_CHARACTER_PRIMITIVE_MEMORY_ABSTRACTION, p6, (void*) STREAM_COMMUNICATION_STYLE_CYBOL_MODEL_COUNT);
...
*/
    ...
    if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
        ...
        compare_all_array((void*) &r, p5, (void*) X_WINDOW_SYSTEM_CYBOL_CHANNEL, (void*) EQUAL_PRIMITIVE_OPERATION_ABSTRACTION, (void*) WIDE_CHARACTER_PRIMITIVE_MEMORY_ABSTRACTION, p6, (void*) X_WINDOW_SYSTEM_CYBOL_CHANNEL_COUNT);
