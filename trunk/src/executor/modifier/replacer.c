...
void replace(void* p0, void* p1, void* p2, void* p3, void* p4, void* p5) {
    ...
    if (p0 != *NULL_POINTER_MEMORY_MODEL) {
        ...
        if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
            ...
            compare_array_equal_wide_character((void*) &r, p4, p5, (void*) CHARACTER_MEMORY_ABSTRACTION, (void*) CHARACTER_MEMORY_ABSTRACTION_COUNT);
        ...
        if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
            ...
            compare_array_equal_wide_character((void*) &r, p4, p5, (void*) COMPLEX_MEMORY_ABSTRACTION, (void*) COMPLEX_MEMORY_ABSTRACTION_COUNT);
    ...
    //??            set_complex_element(*d, p1, p2);
        ...
        if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
            ...
            compare_array_equal_wide_character((void*) &r, p4, p5, (void*) COMPOUND_MEMORY_ABSTRACTION, (void*) COMPOUND_MEMORY_ABSTRACTION_COUNT);
    ...
    //??            set_compound_element(*d, p1, p2);
        ...
        if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
            ...
            compare_array_equal_wide_character((void*) &r, p4, p5, (void*) DATETIME_MEMORY_ABSTRACTION, (void*) DATETIME_MEMORY_ABSTRACTION_COUNT);
    ...
    //??            set_datetime_element(*d, p1, p2);
        ...
        if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
            ...
            compare_array_equal_wide_character((void*) &r, p4, p5, (void*) DOUBLE_MEMORY_ABSTRACTION, (void*) DOUBLE_MEMORY_ABSTRACTION_COUNT);
        ...
        if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
            ...
            compare_array_equal_wide_character((void*) &r, p4, p5, (void*) FRACTION_MEMORY_ABSTRACTION, (void*) FRACTION_MEMORY_ABSTRACTION_COUNT);
    ...
    //??            set_fraction_element(*d, p1, p2);
        ...
        if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
            ...
            compare_array_equal_wide_character((void*) &r, p4, p5, (void*) INTEGER_MEMORY_ABSTRACTION, (void*) INTEGER_MEMORY_ABSTRACTION_COUNT);
        ...
        if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
            ...
            compare_array_equal_wide_character((void*) &r, p4, p5, (void*) INTERNAL_MEMORY_MEMORY_ABSTRACTION, (void*) INTERNAL_MEMORY_MEMORY_ABSTRACTION_COUNT);
    ...
    //??            set_internal_memory_element(*d, p1, p2);
        ...
        if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
            ...
            compare_array_equal_wide_character((void*) &r, p4, p5, (void*) PART_MEMORY_ABSTRACTION, (void*) PART_MEMORY_ABSTRACTION_COUNT);
        ...
        if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
            ...
            compare_array_equal_wide_character((void*) &r, p4, p5, (void*) POINTER_MEMORY_ABSTRACTION, (void*) POINTER_MEMORY_ABSTRACTION_COUNT);
        ...
        if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
            ...
            compare_array_equal_wide_character((void*) &r, p4, p5, (void*) SIGNAL_MEMORY_MEMORY_ABSTRACTION, (void*) SIGNAL_MEMORY_MEMORY_ABSTRACTION_COUNT);
    ...
    //??            set_signal_memory_element(*d, p1, p2);
        ...
        if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
            ...
            compare_array_equal_wide_character((void*) &r, p4, p5, (void*) UNSIGNED_LONG_MEMORY_ABSTRACTION, (void*) UNSIGNED_LONG_MEMORY_ABSTRACTION_COUNT);
        ...
        if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
            ...
            compare_array_equal_wide_character((void*) &r, p4, p5, (void*) WIDE_CHARACTER_MEMORY_ABSTRACTION, (void*) WIDE_CHARACTER_MEMORY_ABSTRACTION_COUNT);
