...
void set_pointer_vector_element(void* p0, void* p1, void* p2) {
    ...
    log_terminated_message((void*) INFORMATION_LOG_LEVEL, (void*) "Set pointer vector element.");
...
void remove_pointer_vector_element(void* p0, void* p1, void* p2) {
    ...
    log_terminated_message((void*) INFORMATION_LOG_LEVEL, (void*) "Remove pointer vector element.");
...
void get_pointer_vector_element(void* p0, void* p1, void* p2) {
    ...
    log_terminated_message((void*) INFORMATION_LOG_LEVEL, (void*) "Get pointer vector element.");
