...
void set_double_vector_element(void* p0, void* p1, void* p2) {
    ...
    log_terminated_message((void*) INFORMATION_LOG_LEVEL, (void*) L"Set double vector element.");

    set_array_elements(p0, p1, p2, (void*) NUMBER_1_INTEGER, (void*) DOUBLE_ARRAY);
}
...
void remove_double_vector_element(void* p0, void* p1, void* p2) {
    ...
    log_terminated_message((void*) INFORMATION_LOG_LEVEL, (void*) L"Remove double vector element.");
...
void get_double_vector_element(void* p0, void* p1, void* p2) {
    ...
    log_terminated_message((void*) INFORMATION_LOG_LEVEL, (void*) L"Get double vector element.");
