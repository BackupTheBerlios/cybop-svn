...
void allocate_pointer_array(void* p0, void* p1) {
    ...
    if (p1 != *NULL_POINTER) {
        ...
        if (p0 != *NULL_POINTER) {
            ...
            log_message((void*) INFORMATION_LOG_LEVEL, (void*) CREATE_POINTER_ARRAY_MESSAGE, (void*) CREATE_POINTER_ARRAY_MESSAGE_COUNT);
...
void deallocate_pointer_array(void* p0, void* p1) {
    ...
    if (p1 != *NULL_POINTER) {
        ...
        if (p0 != *NULL_POINTER) {
            ...
            log_message((void*) INFORMATION_LOG_LEVEL, (void*) DESTROY_POINTER_ARRAY_MESSAGE, (void*) DESTROY_POINTER_ARRAY_MESSAGE_COUNT);
    ...
    if (p2 != *NULL_POINTER) {
        ...
        if (p1 != *NULL_POINTER) {
            ...
            if (p0 != *NULL_POINTER) {
                ...
                log_message((void*) INFORMATION_LOG_LEVEL, (void*) RESIZE_POINTER_ARRAY_MESSAGE, (void*) RESIZE_POINTER_ARRAY_MESSAGE_COUNT);
                ...
                *a = (void*) realloc(*a, m);
                ...
                int n = (*s - *c) * *POINTER_PRIMITIVE_SIZE;
            ...
            log_terminated_message((void*) ERROR_LOG_LEVEL, (void*) L"Could not reallocate pointer array. The array count parameter is null.");
        }
