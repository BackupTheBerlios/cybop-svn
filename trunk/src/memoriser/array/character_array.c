...
void reallocate_character_array(void* p0, void* p1, void* p2) {
    ...
    if (p2 != *NULL_POINTER) {
        ...
        if (p1 != *NULL_POINTER) {
            ...
            log_terminated_message((void*) ERROR_LOG_LEVEL, (void*) L"Could not reallocate character array. The array count parameter is null.");
        }
        ...
        if (p2 != *NULL_POINTER) {
            ...
            if (p1 != *NULL_POINTER) {
                ...
                if (p0 != *NULL_POINTER) {
                    ...
                    // The first element.
                    char* e0 = (char*) *NULL_POINTER;
                    // The second element.
                    char* e1 = (char*) *NULL_POINTER;
                    // The size.
        ...
        if (p2 != *NULL_POINTER) {
            ...
            if (p1 != *NULL_POINTER) {
                ...
                if (p0 != *NULL_POINTER) {
                    ...
                    // The source element.
                    char* se = (char*) *NULL_POINTER;
                    // The destination element.
                    char* de = (char*) *NULL_POINTER;
                    // The loop variable.
                    int j = *NUMBER_0_INTEGER;
                    // The size.
                    int s = *NUMBER_0_INTEGER;
