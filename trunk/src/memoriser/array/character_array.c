 ...
 *
 * @version $RCSfile: character_array.c,v $ $Revision: 1.21 $ $Date: 2009-01-21 22:02:04 $ $Author: christian $
...
void allocate_character_array(void* p0, void* p1) {
    ...
    if (p1 != *NULL_POINTER_MEMORY_MODEL) {
        ...
        if (p0 != *NULL_POINTER_MEMORY_MODEL) {
            ...
            log_message((void*) INFORMATION_LEVEL_LOG_MODEL, (void*) CREATE_CHARACTER_ARRAY_MESSAGE_LOG_MODEL, (void*) CREATE_CHARACTER_ARRAY_MESSAGE_LOG_MODEL_COUNT);
            ...
            *a = (void*) malloc(m);
            ...
            log_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) COULD_NOT_CREATE_CHARACTER_ARRAY_THE_ARRAY_IS_NULL_MESSAGE_LOG_MODEL, (void*) COULD_NOT_CREATE_CHARACTER_ARRAY_THE_ARRAY_IS_NULL_MESSAGE_LOG_MODEL_COUNT);
        }

    } else {

        log_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) COULD_NOT_CREATE_CHARACTER_ARRAY_THE_COUNT_IS_NULL_MESSAGE_LOG_MODEL, (void*) COULD_NOT_CREATE_CHARACTER_ARRAY_THE_COUNT_IS_NULL_MESSAGE_LOG_MODEL_COUNT);
    }
}
...
void deallocate_character_array(void* p0, void* p1) {
    ...
    if (p1 != *NULL_POINTER_MEMORY_MODEL) {
        ...
        if (p0 != *NULL_POINTER_MEMORY_MODEL) {
            ...
            log_message((void*) INFORMATION_LEVEL_LOG_MODEL, (void*) DESTROY_CHARACTER_ARRAY_MESSAGE_LOG_MODEL, (void*) DESTROY_CHARACTER_ARRAY_MESSAGE_LOG_MODEL_COUNT);

            free(*a);

        } else {

            log_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) COULD_NOT_DESTROY_CHARACTER_ARRAY_THE_ARRAY_IS_NULL_MESSAGE_LOG_MODEL, (void*) COULD_NOT_DESTROY_CHARACTER_ARRAY_THE_ARRAY_IS_NULL_MESSAGE_LOG_MODEL_COUNT);
        }

    } else {

        log_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) COULD_NOT_DESTROY_CHARACTER_ARRAY_THE_COUNT_IS_NULL_MESSAGE_LOG_MODEL, (void*) COULD_NOT_DESTROY_CHARACTER_ARRAY_THE_COUNT_IS_NULL_MESSAGE_LOG_MODEL_COUNT);
    }
}
    ...
    if (p2 != *NULL_POINTER_MEMORY_MODEL) {
        ...
        if (p1 != *NULL_POINTER_MEMORY_MODEL) {
            ...
            if (p0 != *NULL_POINTER_MEMORY_MODEL) {
                ...
                log_message((void*) INFORMATION_LEVEL_LOG_MODEL, (void*) RESIZE_CHARACTER_ARRAY_MESSAGE_LOG_MODEL, (void*) RESIZE_CHARACTER_ARRAY_MESSAGE_LOG_MODEL_COUNT);
                ...
                *a = (void*) realloc(*a, m);
                ...
                if (*s >= *c) {
                    ...
                    n = (*s - *c) * *CHARACTER_PRIMITIVE_SIZE;
                }
                ...
                log_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) COULD_NOT_RESIZE_CHARACTER_ARRAY_THE_ARRAY_IS_NULL_MESSAGE_LOG_MODEL, (void*) COULD_NOT_RESIZE_CHARACTER_ARRAY_THE_ARRAY_IS_NULL_MESSAGE_LOG_MODEL_COUNT);
            }
        ...
        log_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) COULD_NOT_RESIZE_CHARACTER_ARRAY_THE_COUNT_IS_NULL_MESSAGE_LOG_MODEL, (void*) COULD_NOT_RESIZE_CHARACTER_ARRAY_THE_COUNT_IS_NULL_MESSAGE_LOG_MODEL_COUNT);
    }
}
