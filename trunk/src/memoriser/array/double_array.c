 ...
 *
 * @version $Revision: 1.18 $ $Date: 2008-05-04 00:18:13 $ $Author: christian $
...
void allocate_double_array(void* p0, void* p1) {
    ...
    if (p1 != *NULL_POINTER) {
        ...
        if (p0 != *NULL_POINTER) {
            ...
            log_message((void*) INFORMATION_LOG_LEVEL, (void*) CREATE_DOUBLE_ARRAY_MESSAGE, (void*) CREATE_DOUBLE_ARRAY_MESSAGE_COUNT);
...
void deallocate_double_array(void* p0, void* p1) {
    ...
    if (p1 != *NULL_POINTER) {
        ...
        if (p0 != *NULL_POINTER) {
            ...
            log_message((void*) INFORMATION_LOG_LEVEL, (void*) DESTROY_DOUBLE_ARRAY_MESSAGE, (void*) DESTROY_DOUBLE_ARRAY_MESSAGE_COUNT);
    ...
    if (p2 != *NULL_POINTER) {
        ...
        if (p1 != *NULL_POINTER) {
            ...
            if (p0 != *NULL_POINTER) {
                ...
                log_message((void*) INFORMATION_LOG_LEVEL, (void*) RESIZE_DOUBLE_ARRAY_MESSAGE, (void*) RESIZE_DOUBLE_ARRAY_MESSAGE_COUNT);
            ...
            log_terminated_message((void*) ERROR_LOG_LEVEL, (void*) L"Could not reallocate double array. The array count parameter is null.");
        }
        ...
        if (p2 != *NULL_POINTER) {
            ...
            if (p1 != *NULL_POINTER) {
                ...
                if (p0 != *NULL_POINTER) {
                    ...
                    // The first element.
                    double* e0 = (double*) *NULL_POINTER;
                    // The second element.
                    double* e1 = (double*) *NULL_POINTER;
                    // The size.
        ...
        if (p2 != *NULL_POINTER) {
            ...
            if (p1 != *NULL_POINTER) {
                ...
                if (p0 != *NULL_POINTER) {
                    ...
                    // The source element.
                    double* se = (double*) *NULL_POINTER;
                    // The destination element.
                    double* de = (double*) *NULL_POINTER;
                    // The loop variable.
                    int j = *NUMBER_0_INTEGER;
                    // The size.
                    int s = *NUMBER_0_INTEGER;
