 ...
 *
 * @version $RCSfile: xml_converter.c,v $ $Revision: 1.21 $ $Date: 2008-09-19 21:12:16 $ $Author: christian $
            ...
            while (*NUMBER_1_INTEGER_MEMORY_MODEL) {
                ...
                if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
                    ...
                    *rem = *rem - *NUMBER_1_INTEGER_MEMORY_MODEL;
                    ...
                    //
                    // The attribute value end or empty tag end or tag end was found.
                    //
                    // CAUTION! In this case, the current position and remaining count
                    // were already changed in the called function, to be processed further
                    // in other functions.
                    //
                    // The tag end and count are left as they are.
                    //
