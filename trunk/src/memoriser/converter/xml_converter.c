 ...
 *
 * @version $RCSfile: xml_converter.c,v $ $Revision: 1.23 $ $Date: 2008-09-20 21:59:39 $ $Author: christian $
 ...
 */
void decode_xml_select_declaration(void* p0, void* p1) {
    ...
    if (p0 != *NULL_POINTER_MEMORY_MODEL) {
        ...
        log_terminated_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) L"Could not select xml declaration. The current byte is null.");
    }
}
...
void decode_xml_select_definition(void* p0, void* p1) {
    ...
    if (p0 != *NULL_POINTER_MEMORY_MODEL) {
        ...
        log_terminated_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) L"Could not select xml definition. The current byte is null.");
    }
}
...
void decode_xml_select_comment(void* p0, void* p1) {
    ...
    if (p0 != *NULL_POINTER_MEMORY_MODEL) {
        ...
        log_terminated_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) L"Could not select xml comment. The current byte is null.");
    }
}
 ...
 */
void decode_xml_select_element_content(void* p0, void* p1, void* p2, void* p3, void* p4, void* p5, void* p6, void* p7) {
    ...
    if (p7 != *NULL_POINTER_MEMORY_MODEL) {
        ...
        if (p6 != *NULL_POINTER_MEMORY_MODEL) {
            ...
            if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
                ...
                decode_xml_detect_end_tag_begin((void*) &r, p6, p7);

                if (r != *NUMBER_0_INTEGER_MEMORY_MODEL) {

                    decode_xml_process_end_tag((void*) &tn, (void*) &tnc, p6, p7);
...
*/
                    ...
                    // Break the loop, because this xml element's end tag
            ...
            if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
                ...
                if (r != *NUMBER_0_INTEGER_MEMORY_MODEL) {
                    ...
                    decode_xml_process_declaration(p3, p4, p5, p6, p7);
                }
            }
            ...
            if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
                ...
                if (r != *NUMBER_0_INTEGER_MEMORY_MODEL) {
                    ...
                    decode_xml_process_definition(p3, p4, p5, p6, p7);
                }
            }
            ...
            if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
                ...
                if (r != *NUMBER_0_INTEGER_MEMORY_MODEL) {
                    ...
                    decode_xml_process_element(p0, p1, p2, p6, p7);
                }
            }
 ...
 * @param p1 the remaining bytes count
 */
void decode_xml_process_declaration(void* p0, void* p1) {
            ...
            if (p1 != *NULL_POINTER_MEMORY_MODEL) {
                ...
                if (p0 != *NULL_POINTER_MEMORY_MODEL) {
                    ...
                    *tn = *pos;
                    ...
                    log_terminated_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) L"Could not process xml end tag. The tag is null.");
                }

            } else {

                log_terminated_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) L"Could not process xml end tag. The tag count is null.");
            }
