...
/**
 * Parses a url message containing escape codes into a message with normal characters.
 *
 ...
 * @param p3 the source url message containing escape codes
 * @param p4 the source url message containing escape codes count
 */
void parse_url_escape_code(void* p0, void* p1, void* p2, void* p3, void* p4) {

    log_message_debug("Information: Parse url escape code.");
}

/**
 * Serialises a message with normal characters into a url message containing escape codes.
 *
 * @param p0 the destination url message containing escape codes (Hand over as reference!)
 * @param p1 the destination url message containing escape codes count
 * @param p2 the destination url message containing escape codes size
...
void serialise_url_escape_code(void* p0, void* p1, void* p2, void* p3, void* p4,
    ...
    log_message_debug("Information: Serialise url escape code.");
}
