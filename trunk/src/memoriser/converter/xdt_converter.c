 ...
 *
 * @version $Revision: 1.21 $ $Date: 2007-09-15 00:17:06 $ $Author: christian $
                            ...
                            if (p2 != *NULL_POINTER) {
                                ...
                                if (p1 != *NULL_POINTER) {
                                    ...
                                    **ds = *NUMBER_0_INTEGER;
                                    ...
                                    // Decode model.
                                    decode(p6, (void*) *mc, (void*) *ms, p9, (void*) *dc, (void*) *ds, p12, p13, *NULL_POINTER, *NULL_POINTER, *NULL_POINTER, *NULL_POINTER, *NULL_POINTER, p14, p15);
