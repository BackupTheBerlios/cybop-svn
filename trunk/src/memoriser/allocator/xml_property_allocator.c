...
void allocate_xml_property(void* p0, void* p1) {
    ...
    log_terminated_message((void*) INFORMATION_LOG_LEVEL, (void*) L"Allocate xml property.");
...
void deallocate_xml_property(void* p0, void* p1) {
    ...
    log_terminated_message((void*) INFORMATION_LOG_LEVEL, (void*) L"Deallocate xml property.");
