/*
 * $RCSfile: unsigned_long_vector_allocator.c,v $
 *
...
void allocate_unsigned_long_vector(void* p0, void* p1) {
    ...
    log_terminated_message((void*) INFORMATION_LOG_LEVEL, (void*) L"Allocate unsigned long vector.");
...
void deallocate_unsigned_long_vector(void* p0, void* p1) {
    ...
    log_terminated_message((void*) INFORMATION_LOG_LEVEL, (void*) L"Deallocate unsigned long vector.");
