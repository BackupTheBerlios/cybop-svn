...
void allocate_character_vector(void* p0, void* p1) {
    ...
    log_terminated_message((void*) INFORMATION_LOG_LEVEL, (void*) L"Allocate character vector.");
...
void deallocate_character_vector(void* p0, void* p1) {
    ...
    log_terminated_message((void*) INFORMATION_LOG_LEVEL, (void*) L"Deallocate character vector.");
