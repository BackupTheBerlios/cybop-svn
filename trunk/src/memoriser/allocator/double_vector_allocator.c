...
void allocate_double_vector(void* p0, void* p1) {
    ...
    log_terminated_message((void*) INFORMATION_LOG_LEVEL, (void*) L"Allocate double vector.");
...
void deallocate_double_vector(void* p0, void* p1) {
    ...
    log_terminated_message((void*) INFORMATION_LOG_LEVEL, (void*) L"Deallocate double vector.");
