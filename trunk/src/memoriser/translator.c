...
#include "../../controller/translator/cybol_translator.c"
#include "../../controller/translator/html_translator.c"
#include "../../controller/translator/x_window_system_translator.c"
