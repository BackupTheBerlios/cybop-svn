 ...
 *
 * @version $RCSfile: allocator.c,v $ $Revision: 1.28 $ $Date: 2008-09-08 21:28:36 $ $Author: christian $
...
void allocate(void* p0, void* p1, void* p2, void* p3) {
    ...
    if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
        ...
        compare_arrays(p2, p3, (void*) HH_MM_SS_DATETIME_CYBOL_ABSTRACTION, (void*) HH_MM_SS_DATETIME_CYBOL_ABSTRACTION_COUNT, (void*) &r, (void*) WIDE_CHARACTER_ARRAY_MEMORY_ABSTRACTION);
