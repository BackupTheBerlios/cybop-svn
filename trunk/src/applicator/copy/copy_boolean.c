...
#ifndef COPY_BOOLEAN_SOURCE
#define COPY_BOOLEAN_SOURCE
        ...
        if (p2 != *NULL_POINTER) {
            ...
            if (p1 != *NULL_POINTER) {
                ...
                if (p0 != *NULL_POINTER) {
                    ...
                    log_message_debug("Copy boolean.");
                    ...
                    log_message_debug("Could not copy boolean. The destination is null.");
                }

            } else {

                log_message_debug("Could not copy boolean. The destination count is null.");
            }

        } else {

            log_message_debug("Could not copy boolean. The destination size is null.");
        }

    } else {

        log_message_debug("Could not copy boolean. The source count is null.");
    }
}
