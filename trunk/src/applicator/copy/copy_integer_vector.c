/*
 * $RCSfile: copy_integer_vector.c,v $
 *
 ...
 *
 * @version $Revision: 1.7 $ $Date: 2008-05-04 00:18:10 $ $Author: christian $
 * @author Christian Heller <christian.heller@tuxtax.de>
 */

#ifndef COPY_INTEGER_VECTOR_SOURCE
#define COPY_INTEGER_VECTOR_SOURCE
        ...
        if (p2 != *NULL_POINTER) {
            ...
            if (p1 != *NULL_POINTER) {
                ...
                if (p0 != *NULL_POINTER) {
                    ...
                    log_terminated_message((void*) INFORMATION_LOG_LEVEL, (void*) L"Copy integer vector.");
                    ...
                    log_terminated_message((void*) ERROR_LOG_LEVEL, (void*) L"Could not copy integer vector. The destination is null.");
                }

            } else {

                log_terminated_message((void*) ERROR_LOG_LEVEL, (void*) L"Could not copy integer vector. The destination count is null.");
            }

        } else {

            log_terminated_message((void*) ERROR_LOG_LEVEL, (void*) L"Could not copy integer vector. The destination size is null.");
        }

    } else {

        log_terminated_message((void*) ERROR_LOG_LEVEL, (void*) L"Could not copy integer vector. The source count is null.");
    }
}

/* COPY_INTEGER_VECTOR_SOURCE */
#endif
