 ...
 *
 * @version $Revision: 1.34 $ $Date: 2008-05-04 00:18:11 $ $Author: christian $
...
void receive_x_window_system(void* p0, void* p1, void* p2, void* p3, void* p4, void* p5, void* p6) {
    ...
    log_terminated_message((void*) INFORMATION_LOG_LEVEL, (void*) L"Receive x window system message.");
