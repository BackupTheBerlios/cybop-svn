 ...
 *
 * @version $RCSfile: archiving_filer.c,v $ $Revision: 1.1 $ $Date: 2009-01-07 01:14:05 $ $Author: christian $
...
void file_archiving(void* p0, void* p1, void* p2, void* p3) {
    ...
    if (*createm != *NULL_POINTER_MEMORY_MODEL) {
        ...
        if (**createm == *NUMBER_1_INTEGER_MEMORY_MODEL) {
            ...
            if ((argc + *PRIMITIVE_MEMORY_MODEL_COUNT + *CREATE_ARCHIVE_FILE_OPERATION_CYBOL_NAME_COUNT) >= args) {

                // Determine arguments size.
                args = argc * *POINTER_VECTOR_REALLOCATION_FACTOR + *PRIMITIVE_MEMORY_MODEL_COUNT + *CREATE_ARCHIVE_FILE_OPERATION_CYBOL_NAME_COUNT;
            ...
            set_array_elements(arg, (void*) &argc, (void*) CREATE_ARCHIVE_FILE_OPERATION_CYBOL_NAME, (void*) CREATE_ARCHIVE_FILE_OPERATION_CYBOL_NAME_COUNT, (void*) WIDE_CHARACTER_ARRAY_MEMORY_ABSTRACTION);
            argc = argc + *CREATE_ARCHIVE_FILE_OPERATION_CYBOL_NAME_COUNT;
        }
    }
    ...
    if (*updatem != *NULL_POINTER_MEMORY_MODEL) {
        ...
        if (**updatem == *NUMBER_1_INTEGER_MEMORY_MODEL) {
            ...
            // Resize arguments, if necessary.
            // One extra place for space character.
            if ((argc + *PRIMITIVE_MEMORY_MODEL_COUNT + *UPDATE_ARCHIVE_FILE_OPERATION_CYBOL_NAME_COUNT) >= args) {

                // Determine arguments size.
                args = argc * *POINTER_VECTOR_REALLOCATION_FACTOR + *PRIMITIVE_MEMORY_MODEL_COUNT + *UPDATE_ARCHIVE_FILE_OPERATION_CYBOL_NAME_COUNT;
            ...
            set_array_elements(arg, (void*) &argc, (void*) SPACE_UNICODE_CHARACTER_CODE_MODEL, (void*) PRIMITIVE_MEMORY_MODEL_COUNT, (void*) WIDE_CHARACTER_ARRAY_MEMORY_ABSTRACTION);
            argc = argc + *PRIMITIVE_MEMORY_MODEL_COUNT;
            set_array_elements(arg, (void*) &argc, (void*) UPDATE_ARCHIVE_FILE_OPERATION_CYBOL_NAME, (void*) UPDATE_ARCHIVE_FILE_OPERATION_CYBOL_NAME_COUNT, (void*) WIDE_CHARACTER_ARRAY_MEMORY_ABSTRACTION);
            argc = argc + *UPDATE_ARCHIVE_FILE_OPERATION_CYBOL_NAME_COUNT;
        }
    }
    ...
    if (*bzip2m != *NULL_POINTER_MEMORY_MODEL) {
        ...
        if (**bzip2m == *NUMBER_1_INTEGER_MEMORY_MODEL) {
            ...
            // Resize arguments, if necessary.
            // One extra place for space character.
            if ((argc + *PRIMITIVE_MEMORY_MODEL_COUNT + *BZIP2_ARCHIVE_FILE_OPERATION_CYBOL_NAME_COUNT) >= args) {

                // Determine arguments size.
                args = argc * *POINTER_VECTOR_REALLOCATION_FACTOR + *PRIMITIVE_MEMORY_MODEL_COUNT + *BZIP2_ARCHIVE_FILE_OPERATION_CYBOL_NAME_COUNT;
            ...
            set_array_elements(arg, (void*) &argc, (void*) SPACE_UNICODE_CHARACTER_CODE_MODEL, (void*) PRIMITIVE_MEMORY_MODEL_COUNT, (void*) WIDE_CHARACTER_ARRAY_MEMORY_ABSTRACTION);
            argc = argc + *PRIMITIVE_MEMORY_MODEL_COUNT;
            set_array_elements(arg, (void*) &argc, (void*) BZIP2_ARCHIVE_FILE_OPERATION_CYBOL_NAME, (void*) BZIP2_ARCHIVE_FILE_OPERATION_CYBOL_NAME_COUNT, (void*) WIDE_CHARACTER_ARRAY_MEMORY_ABSTRACTION);
            argc = argc + *BZIP2_ARCHIVE_FILE_OPERATION_CYBOL_NAME_COUNT;
        }
    }
...
/*??
    ...
    if (*createm != *NULL_POINTER_MEMORY_MODEL) {
        ...
        if (**createm == *NUMBER_1_INTEGER_MEMORY_MODEL) {
            ...
            // One extra place for space character.
            if ((commandc + *PRIMITIVE_MEMORY_MODEL_COUNT + *CREATE_ARCHIVE_FILE_OPERATION_CYBOL_NAME_COUNT) >= commands) {

                // Determine command size.
                commands = commandc * *POINTER_VECTOR_REALLOCATION_FACTOR + *PRIMITIVE_MEMORY_MODEL_COUNT + *CREATE_ARCHIVE_FILE_OPERATION_CYBOL_NAME_COUNT;
            ...
            set_array_elements(command, (void*) &commandc, (void*) CREATE_ARCHIVE_FILE_OPERATION_CYBOL_NAME, (void*) CREATE_ARCHIVE_FILE_OPERATION_CYBOL_NAME_COUNT, (void*) WIDE_CHARACTER_ARRAY_MEMORY_ABSTRACTION);
            commandc = commandc + *CREATE_ARCHIVE_FILE_OPERATION_CYBOL_NAME_COUNT;
        }
    }
    ...
    if (*updatem != *NULL_POINTER_MEMORY_MODEL) {
        ...
        if (**updatem == *NUMBER_1_INTEGER_MEMORY_MODEL) {
            ...
            // Resize command, if necessary.
            // One extra place for space character.
            if ((commandc + *PRIMITIVE_MEMORY_MODEL_COUNT + *UPDATE_ARCHIVE_FILE_OPERATION_CYBOL_NAME_COUNT) >= commands) {

                // Determine command size.
                commands = commandc * *POINTER_VECTOR_REALLOCATION_FACTOR + *PRIMITIVE_MEMORY_MODEL_COUNT + *UPDATE_ARCHIVE_FILE_OPERATION_CYBOL_NAME_COUNT;
            ...
            set_array_elements(command, (void*) &commandc, (void*) SPACE_UNICODE_CHARACTER_CODE_MODEL, (void*) PRIMITIVE_MEMORY_MODEL_COUNT, (void*) WIDE_CHARACTER_ARRAY_MEMORY_ABSTRACTION);
            commandc = commandc + *PRIMITIVE_MEMORY_MODEL_COUNT;
            set_array_elements(command, (void*) &commandc, (void*) UPDATE_ARCHIVE_FILE_OPERATION_CYBOL_NAME, (void*) UPDATE_ARCHIVE_FILE_OPERATION_CYBOL_NAME_COUNT, (void*) WIDE_CHARACTER_ARRAY_MEMORY_ABSTRACTION);
            commandc = commandc + *UPDATE_ARCHIVE_FILE_OPERATION_CYBOL_NAME_COUNT;
        }
    }
    ...
    if (*bzip2m != *NULL_POINTER_MEMORY_MODEL) {
        ...
        if (**bzip2m == *NUMBER_1_INTEGER_MEMORY_MODEL) {
            ...
            // Resize command, if necessary.
            // One extra place for space character.
            if ((commandc + *PRIMITIVE_MEMORY_MODEL_COUNT + *BZIP2_ARCHIVE_FILE_OPERATION_CYBOL_NAME_COUNT) >= commands) {

                // Determine command size.
                commands = commandc * *POINTER_VECTOR_REALLOCATION_FACTOR + *PRIMITIVE_MEMORY_MODEL_COUNT + *BZIP2_ARCHIVE_FILE_OPERATION_CYBOL_NAME_COUNT;
            ...
            set_array_elements(command, (void*) &commandc, (void*) SPACE_UNICODE_CHARACTER_CODE_MODEL, (void*) PRIMITIVE_MEMORY_MODEL_COUNT, (void*) WIDE_CHARACTER_ARRAY_MEMORY_ABSTRACTION);
            commandc = commandc + *PRIMITIVE_MEMORY_MODEL_COUNT;
            set_array_elements(command, (void*) &commandc, (void*) BZIP2_ARCHIVE_FILE_OPERATION_CYBOL_NAME, (void*) BZIP2_ARCHIVE_FILE_OPERATION_CYBOL_NAME_COUNT, (void*) WIDE_CHARACTER_ARRAY_MEMORY_ABSTRACTION);
            commandc = commandc + *BZIP2_ARCHIVE_FILE_OPERATION_CYBOL_NAME_COUNT;
        }
    }
