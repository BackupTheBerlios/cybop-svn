...
void shutdown_x_window_system(void* p0, void* p1, void* p2) {
    ...
    log_terminated_message((void*) INFORMATION_LOG_LEVEL, (void*) L"Shutdown x window system.");
...
//??        deallocate((void*) f, (void*) PRIMITIVE_COUNT, (void*) INTEGER_VECTOR_ABSTRACTION, (void*) INTEGER_VECTOR_ABSTRACTION_COUNT);
        ...
        log_terminated_message((void*) WARNING_LOG_LEVEL, (void*) L"Could not shutdown x window system. There is no x window system running.");
    }
}
