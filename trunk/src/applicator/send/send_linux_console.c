 ...
 *
 * @version $Revision: 1.33 $ $Date: 2005-08-09 13:04:26 $ $Author: christian $
        ...
        if (p3 != NULL_POINTER) {
            ...
            if (p2 != NULL_POINTER) {
                ...
                if (p1 != NULL_POINTER) {
                    ...
                    set_array_elements((void*) &tn, (void*) CHARACTER_ARRAY, p4, (void*) &NULL_CONTROL_CHARACTER, (void*) &CHARACTER_COUNT);
