 ...
 *
 * @version $Revision: 1.19 $ $Date: 2007-04-23 23:15:07 $ $Author: christian $
...
void send_x_window_system(void* p0, void* p1, void* p2, void* p3, void* p4) {
    ...
    serialise(p0, NULL_POINTER, NULL_POINTER, NULL_POINTER, NULL_POINTER, p1, p2, NULL_POINTER, NULL_POINTER, p3, p4, (void*) X_WINDOW_SYSTEM_MODEL, (void*) X_WINDOW_SYSTEM_MODEL_COUNT);
