...
void startup_gnu_linux_console(void* p0, void* p1, void* p2, void* p3) {
    ...
    log_terminated_message((void*) INFORMATION_LOG_LEVEL, (void*) L"Startup gnu/linux console.");
...
//??        allocate((void*) &op, (void*) PRIMITIVE_COUNT, (void*) INTEGER_VECTOR_ABSTRACTION, (void*) INTEGER_VECTOR_ABSTRACTION_COUNT);
        ...
        *bs = *NUMBER_3_INTEGER;
        ...
        if (l == *NUMBER_0_INTEGER) {
            ...
            log_terminated_message((void*) DEBUG_LOG_LEVEL, (void*) L"This is a gnu/linux console.");

        } else {

            log_terminated_message((void*) DEBUG_LOG_LEVEL, (void*) L"This is a standard serial terminal.");
        }
        ...
        log_terminated_message((void*) WARNING_LOG_LEVEL, (void*) L"Could not startup gnu/linux console. The gnu/linux console input or output or both are already running.");
    }
}
