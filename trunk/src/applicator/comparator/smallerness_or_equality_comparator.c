 ...
 *
 * @version $RCSfile: smallerness_or_equality_comparator.c,v $ $Revision: 1.2 $ $Date: 2008-09-04 20:31:29 $ $Author: christian $
 ...
 */
void compare_smaller_or_equal(void* p0, void* p1, void* p2,
    ...
    if (p21 != *NULL_POINTER_MEMORY_MODEL) {
        ...
        if (p12 != *NULL_POINTER_MEMORY_MODEL) {
            ...
            if (p3 != *NULL_POINTER_MEMORY_MODEL) {
                ...
                log_terminated_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) L"Could not compare if one parameter is smaller than or equal to the other. The left side parameter is null.");
            }

        } else {

            log_terminated_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) L"Could not compare if one parameter is smaller than or equal to the other. The right side parameter is null.");
        }

    } else {

        log_terminated_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) L"Could not compare if one parameter is smaller than or equal to the other. The result parameter is null.");
    }
}
