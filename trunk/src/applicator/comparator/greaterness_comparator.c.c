 ...
 *
 * @version $RCSfile: greaterness_comparator.c.c,v $ $Revision: 1.1 $ $Date: 2008-09-03 22:03:59 $ $Author: christian $
 ...
 */
void compare_greater(void* p0, void* p1, void* p2,
    ...
    if (p21 != *NULL_POINTER_MEMORY_MODEL) {
        ...
        if (p12 != *NULL_POINTER_MEMORY_MODEL) {
            ...
            if (p3 != *NULL_POINTER_MEMORY_MODEL) {
                ...
                log_terminated_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) L"Could not compare if one parameter is greater than the other. The left side parameter is null.");
            }

        } else {

            log_terminated_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) L"Could not compare if one parameter is greater than the other. The right side parameter is null.");
        }

    } else {

        log_terminated_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) L"Could not compare if one parameter is greater than the other. The result parameter is null.");
    }
}
