 ...
 *
 * @version $RCSfile: prefix_equality_comparator.c,v $ $Revision: 1.8 $ $Date: 2009-10-06 21:25:26 $ $Author: christian $
 * @author Christian Heller <christian.heller@tuxtax.de>
 */

#ifndef PREFIX_EQUALITY_COMPARATOR_SOURCE
#define PREFIX_EQUALITY_COMPARATOR_SOURCE
...
/**
 * Compares if the right parameter is a prefix of the left parameter.
 *
 ...
 */
void compare_equality_prefix(void* p0, void* p1, void* p2,
            ...
            if (p12 != *NULL_POINTER_MEMORY_MODEL) {
                ...
                if (p4 != *NULL_POINTER_MEMORY_MODEL) {
                    ...
                    if (p3 != *NULL_POINTER_MEMORY_MODEL) {
                        ...
                        log_terminated_message((void*) INFORMATION_LEVEL_LOG_MODEL, (void*) L"Compare if right parameter is a prefix of the left parameter.");
                        ...
                        if (r != *NUMBER_0_INTEGER_MEMORY_MODEL) {
                            ...
                            if ((lr != *NUMBER_0_INTEGER_MEMORY_MODEL) && (rr != *NUMBER_0_INTEGER_MEMORY_MODEL)) {
                                ...
                                if (*lsmc >= *rsmc) {
                                    ...
                                    compare_all_array((void*) &r, p3, p12, (void*) EQUAL_PRIMITIVE_OPERATION_ABSTRACTION, (void*) WIDE_CHARACTER_PRIMITIVE_MEMORY_ABSTRACTION, p13, p13);
                            ...
                            log_terminated_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) L"Could not compare if right parameter is a prefix of the left parameter. The result parameter is not a boolean.");
                        }

                    } else {

                        log_terminated_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) L"Could not compare if right parameter is a prefix of the left parameter. The left side parameter is null.");
                    }

                } else {

                    log_terminated_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) L"Could not compare if right parameter is a prefix of the left parameter. The left side parameter model count is null.");
                }

            } else {

                log_terminated_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) L"Could not compare if right parameter is a prefix of the left parameter. The right side parameter is null.");
            }

        } else {

            log_terminated_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) L"Could not compare if right parameter is a prefix of the left parameter. The right side parameter model count is null.");
        }

    } else {

        log_terminated_message((void*) ERROR_LEVEL_LOG_MODEL, (void*) L"Could not compare if right parameter is a prefix of the left parameter. The result parameter is null.");
    }
}

/* PREFIX_EQUALITY_COMPARATOR_SOURCE */
#endif
