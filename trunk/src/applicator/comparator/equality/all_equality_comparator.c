...
/*??
                    // Compare parameter abstractions.
                    compare_array_equal_wide_character((void*) &lr, p0, p1, (void*) PLAIN_TEXT_CYBOL_ABSTRACTION, (void*) PLAIN_TEXT_CYBOL_ABSTRACTION_COUNT);
                    compare_array_equal_wide_character((void*) &rr, p9, p10, (void*) PLAIN_TEXT_CYBOL_ABSTRACTION, (void*) PLAIN_TEXT_CYBOL_ABSTRACTION_COUNT);
*/
                    ...
                    if ((lr != *NUMBER_0_INTEGER_MEMORY_MODEL) && (rr != *NUMBER_0_INTEGER_MEMORY_MODEL)) {
                        ...
                        compare_array_equal_wide_character((void*) &r, p3, p4, p12, p13);
                    ...
                    // Compare parameter abstractions.
                    compare_array_equal_wide_character((void*) &lr, p0, p1, (void*) INTEGER_MEMORY_ABSTRACTION, (void*) INTEGER_MEMORY_ABSTRACTION_COUNT);
                    compare_array_equal_wide_character((void*) &rr, p9, p10, (void*) INTEGER_MEMORY_ABSTRACTION, (void*) INTEGER_MEMORY_ABSTRACTION_COUNT);
                    ...
                    // Compare parameter abstractions.
                    compare_array_equal_wide_character((void*) &lr, p0, p1, (void*) DOUBLE_MEMORY_ABSTRACTION, (void*) DOUBLE_MEMORY_ABSTRACTION_COUNT);
                    compare_array_equal_wide_character((void*) &rr, p9, p10, (void*) DOUBLE_MEMORY_ABSTRACTION, (void*) DOUBLE_MEMORY_ABSTRACTION_COUNT);

/*
                    // Compare parameter abstractions.
                    compare_array_equal_wide_character((void*) &lr, p0, p1, (void*) DECIMAL_FRACTION_NUMBER_CYBOL_ABSTRACTION, (void*) DECIMAL_FRACTION_NUMBER_CYBOL_ABSTRACTION_COUNT);
                    compare_array_equal_wide_character((void*) &rr, p9, p10, (void*) DECIMAL_FRACTION_NUMBER_CYBOL_ABSTRACTION, (void*) DECIMAL_FRACTION_NUMBER_CYBOL_ABSTRACTION_COUNT);
*/
