 ...
 *
 * @version $Revision: 1.10 $ $Date: 2008-05-04 00:18:10 $ $Author: christian $
            ...
            if (p2 != *NULL_POINTER) {
                ...
                if (p1 != *NULL_POINTER) {
                    ...
                    if (p0 != *NULL_POINTER) {
                        ...
                        log_terminated_message((void*) INFORMATION_LOG_LEVEL, (void*) L"Add integer vectors.");
                        ...
                        *sc = *NUMBER_0_INTEGER;
                        ...
                        log_terminated_message((void*) ERROR_LOG_LEVEL, (void*) L"Could not add integer vectors. The sum is null.");
                    }

                } else {

                    log_terminated_message((void*) ERROR_LOG_LEVEL, (void*) L"Could not add integer vectors. The sum count is null.");
                }

            } else {

                log_terminated_message((void*) ERROR_LOG_LEVEL, (void*) L"Could not add integer vectors. The sum size is null.");
            }

        } else {

            log_terminated_message((void*) ERROR_LOG_LEVEL, (void*) L"Could not add integer vectors. The summand 1 count is null.");
        }

    } else {

        log_terminated_message((void*) ERROR_LOG_LEVEL, (void*) L"Could not add integer vectors. The summand 2 count is null.");
    }
}
