/*
 * $RCSfile: compare_equal_prefix.c,v $
 *
...
#ifndef COMPARE_EQUAL_PREFIX_SOURCE
#define COMPARE_EQUAL_PREFIX_SOURCE
            ...
            if (p12 != *NULL_POINTER) {
                ...
                if (p4 != *NULL_POINTER) {
                    ...
                    if (p3 != *NULL_POINTER) {
                        ...
                        log_terminated_message((void*) INFORMATION_LOG_LEVEL, (void*) L"Compare if right parameter is a prefix of the left parameter.");
                        ...
                        if (r != *NUMBER_0_INTEGER) {
                            ...
                            if ((lr != *NUMBER_0_INTEGER) && (rr != *NUMBER_0_INTEGER)) {
                                ...
                                if (*lsmc >= *rsmc) {
                                    ...
                                    compare_arrays(p3, p13, p12, p13, (void*) &r, (void*) WIDE_CHARACTER_ARRAY);
                            ...
                            log_terminated_message((void*) ERROR_LOG_LEVEL, (void*) L"Could not compare if right parameter is a prefix of the left parameter. The result parameter is not a boolean.");
                        }

                    } else {

                        log_terminated_message((void*) ERROR_LOG_LEVEL, (void*) L"Could not compare if right parameter is a prefix of the left parameter. The left side parameter is null.");
                    }

                } else {

                    log_terminated_message((void*) ERROR_LOG_LEVEL, (void*) L"Could not compare if right parameter is a prefix of the left parameter. The left side parameter model count is null.");
                }

            } else {

                log_terminated_message((void*) ERROR_LOG_LEVEL, (void*) L"Could not compare if right parameter is a prefix of the left parameter. The right side parameter is null.");
            }

        } else {

            log_terminated_message((void*) ERROR_LOG_LEVEL, (void*) L"Could not compare if right parameter is a prefix of the left parameter. The right side parameter model count is null.");
        }

    } else {

        log_terminated_message((void*) ERROR_LOG_LEVEL, (void*) L"Could not compare if right parameter is a prefix of the left parameter. The result parameter is null.");
    }
}

/* COMPARE_EQUAL_PREFIX_SOURCE */
#endif
