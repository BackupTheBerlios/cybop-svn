            ...
            if (p12 != *NULL_POINTER) {
                ...
                if (p4 != *NULL_POINTER) {
                    ...
                    if (p3 != *NULL_POINTER) {
                        ...
                        log_message_debug("Information: Compare if right parameter is a suffix of the left parameter.");
                        ...
                        if (r != *NUMBER_0_INTEGER) {
                            ...
                            log_message_debug("Error: Could not compare if right parameter is a suffix of the left parameter. The result parameter is not a boolean.");
                        }

                    } else {

                        log_message_debug("Error: Could not compare if right parameter is a suffix of the left parameter. The left side parameter is null.");
                    }

                } else {

                    log_message_debug("Error: Could not compare if right parameter is a suffix of the left parameter. The left side parameter model count is null.");
                }

            } else {

                log_message_debug("Error: Could not compare if right parameter is a suffix of the left parameter. The right side parameter is null.");
            }

        } else {

            log_message_debug("Error: Could not compare if right parameter is a suffix of the left parameter. The right side parameter model count is null.");
        }

    } else {

        log_message_debug("Error: Could not compare if right parameter is a suffix of the left parameter. The result parameter is null.");
    }
}
