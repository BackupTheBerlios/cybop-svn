...
#ifndef COMPARE_SMALLER_OR_EQUAL_SOURCE
#define COMPARE_SMALLER_OR_EQUAL_SOURCE
    ...
    if (p21 != *NULL_POINTER) {
        ...
        if (p12 != *NULL_POINTER) {
            ...
            if (p3 != *NULL_POINTER) {
                ...
                log_terminated_message((void*) INFORMATION_LOG_LEVEL, (void*) L"Compare if one parameter is smaller than or equal to the other.");
                ...
                if (r != *NUMBER_0_INTEGER) {
                    ...
                    // Compare parameter abstractions.
                    compare_arrays(p0, p1, (void*) INTEGER_VECTOR_ABSTRACTION, (void*) INTEGER_VECTOR_ABSTRACTION_COUNT, (void*) &lr, (void*) WIDE_CHARACTER_ARRAY);
                    compare_arrays(p9, p10, (void*) INTEGER_VECTOR_ABSTRACTION, (void*) INTEGER_VECTOR_ABSTRACTION_COUNT, (void*) &rr, (void*) WIDE_CHARACTER_ARRAY);
                    ...
                    // Compare parameter abstractions.
                    compare_arrays(p0, p1, (void*) DOUBLE_VECTOR_ABSTRACTION, (void*) DOUBLE_VECTOR_ABSTRACTION_COUNT, (void*) &lr, (void*) WIDE_CHARACTER_ARRAY);
                    compare_arrays(p9, p10, (void*) DOUBLE_VECTOR_ABSTRACTION, (void*) DOUBLE_VECTOR_ABSTRACTION_COUNT, (void*) &rr, (void*) WIDE_CHARACTER_ARRAY);
                    ...
                    log_terminated_message((void*) ERROR_LOG_LEVEL, (void*) L"Could not compare if one parameter is smaller than or equal to the other. The result parameter is not a boolean.");
                }

            } else {

                log_terminated_message((void*) ERROR_LOG_LEVEL, (void*) L"Could not compare if one parameter is smaller than or equal to the other. The left side parameter is null.");
            }

        } else {

            log_terminated_message((void*) ERROR_LOG_LEVEL, (void*) L"Could not compare if one parameter is smaller than or equal to the other. The right side parameter is null.");
        }

    } else {

        log_terminated_message((void*) ERROR_LOG_LEVEL, (void*) L"Could not compare if one parameter is smaller than or equal to the other. The result parameter is null.");
    }
}

/* COMPARE_SMALLER_OR_EQUAL_SOURCE */
#endif
