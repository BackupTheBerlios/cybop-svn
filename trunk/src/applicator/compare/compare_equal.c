...
void compare_equal(void* p0, void* p1, void* p2,
    ...
    log_terminated_message((void*) INFORMATION_LOG_LEVEL, (void*) L"Compare if left parameter is equal to right parameter.");
    ...
    if (r == *NUMBER_0_INTEGER) {
        ...
        log_terminated_message((void*) WARNING_LOG_LEVEL, (void*) L"Could not compare if left parameter is equal to right parameter. The selection parameter model is unknown.");
    }
}
