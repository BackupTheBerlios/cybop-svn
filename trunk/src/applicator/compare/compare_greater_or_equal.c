/*
 * $RCSfile: compare_greater_or_equal.c,v $
 *
    ...
    if (p21 != *NULL_POINTER) {
        ...
        if (p12 != *NULL_POINTER) {
            ...
            if (p3 != *NULL_POINTER) {
                ...
                log_terminated_message((void*) INFORMATION_LOG_LEVEL, (void*) L"Compare if one parameter is greater than or equal to the other.");
                ...
                if (r != *NUMBER_0_INTEGER) {
                    ...
                    log_terminated_message((void*) ERROR_LOG_LEVEL, (void*) L"Could not compare if one parameter is greater than or equal to the other. The result parameter is not a boolean.");
                }

            } else {

                log_terminated_message((void*) ERROR_LOG_LEVEL, (void*) L"Could not compare if one parameter is greater than or equal to the other. The left side parameter is null.");
            }

        } else {

            log_terminated_message((void*) ERROR_LOG_LEVEL, (void*) L"Could not compare if one parameter is greater than or equal to the other. The right side parameter is null.");
        }

    } else {

        log_terminated_message((void*) ERROR_LOG_LEVEL, (void*) L"Could not compare if one parameter is greater than or equal to the other. The result parameter is null.");
    }
}

/* COMPARE_GREATER_OR_EQUAL_SOURCE */
#endif
