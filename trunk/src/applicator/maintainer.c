 ...
 *
 * @version $RCSfile: maintainer.c,v $ $Revision: 1.4 $ $Date: 2008-09-07 23:01:38 $ $Author: christian $
 * @author Christian Heller <christian.heller@tuxtax.de>
 */

#ifndef MAINTAINER_SOURCE
#define MAINTAINER_SOURCE
 ...
 */
void maintain(void* p0, int* p1, void* p2, void* p3, void* p4, void* p5, void* p6) {

    log_terminated_message((void*) INFORMATION_LEVEL_LOG_MODEL, (void*) L"Maintain system lifecycle.");
    ...
    if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
        ...
        compare_arrays(*tm, *tmc, (void*) EXIT_LIFECYCLE_OPERATION_CYBOL_MODEL, (void*) EXIT_LIFECYCLE_OPERATION_CYBOL_MODEL_COUNT, (void*) &r, (void*) WIDE_CHARACTER_ARRAY_MEMORY_ABSTRACTION);
    ...
    if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
        ...
        compare_arrays(*tm, *tmc, (void*) SHUTDOWN_LIFECYCLE_OPERATION_CYBOL_MODEL, (void*) SHUTDOWN_LIFECYCLE_OPERATION_CYBOL_MODEL_COUNT, (void*) &r, (void*) WIDE_CHARACTER_ARRAY_MEMORY_ABSTRACTION);
    ...
    if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
        ...
        compare_arrays(*tm, *tmc, (void*) STARTUP_LIFECYCLE_OPERATION_CYBOL_MODEL, (void*) STARTUP_LIFECYCLE_OPERATION_CYBOL_MODEL_COUNT, (void*) &r, (void*) WIDE_CHARACTER_ARRAY_MEMORY_ABSTRACTION);
    ...
    if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
        ...
        log_terminated_message((void*) WARNING_LEVEL_LOG_MODEL, (void*) L"Could not maintain system lifecycle. The operation type is unknown.");
    }
}
