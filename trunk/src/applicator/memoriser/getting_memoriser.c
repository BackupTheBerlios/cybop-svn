...
void memorise_getting(void* p0, int* p1, void* p2, void* p3, void* p4) {
    ...
    if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
        ...
        compare_array_equal_wide_character((void*) &r, *dm, *dmc, (void*) NAME_GET_DESCRIPTION_CYBOL_MODEL, (void*) NAME_GET_DESCRIPTION_CYBOL_MODEL_COUNT);
    ...
    if (r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
        ...
        compare_array_equal_wide_character((void*) &r, *dm, *dmc, (void*) ABSTRACTION_GET_DESCRIPTION_CYBOL_MODEL, (void*) ABSTRACTION_GET_DESCRIPTION_CYBOL_MODEL_COUNT);
