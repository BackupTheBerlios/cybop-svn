 ...
 *
 * @version $RCSfile: integer_vector_copying_memoriser.c,v $ $Revision: 1.3 $ $Date: 2008-09-09 21:17:22 $ $Author: christian $
 * @author Christian Heller <christian.heller@tuxtax.de>
 */

#ifndef INTEGER_VECTOR_COPIER_SOURCE
#define INTEGER_VECTOR_COPIER_SOURCE
