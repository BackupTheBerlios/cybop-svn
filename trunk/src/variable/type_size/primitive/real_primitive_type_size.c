...
#ifndef REAL_PRIMITIVE_TYPE_SIZE_SOURCE
#define REAL_PRIMITIVE_TYPE_SIZE_SOURCE
...
/**
 * The float real primitive type size.
 *
 * single-precision
 *
 ...
 * Typical size [Bit]: 32
 */
static int* FLOAT_REAL_PRIMITIVE_TYPE_SIZE;

/**
 * The double real primitive type size.
 *
 * double-precision
 *
 * Minimum allowed range: 1×10^−37..1×10^37
 ...
 * Typical size [Bit]: 64
 */
static int* DOUBLE_REAL_PRIMITIVE_TYPE_SIZE;

/**
 * The long double real primitive type size.
 *
 ...
 */
static int* LONG_DOUBLE_REAL_PRIMITIVE_TYPE_SIZE;

/* REAL_PRIMITIVE_TYPE_SIZE_SOURCE */
#endif
