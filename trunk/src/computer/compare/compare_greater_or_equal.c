 ...
 */
void compare_greater_or_equal(const void* p0, const void* p1, const void* p2,
    ...
    if (p21 != NULL_POINTER) {
        ...
        if (p12 != NULL_POINTER) {
            ...
            if (p3 != NULL_POINTER) {
                ...
                if (r == 1) {
                    ...
                    log_message_debug("Could not compare if one parameter is greater than or equal to the other. The result parameter is not a boolean.");
                }

            } else {

                log_message_debug("Could not compare if one parameter is greater than or equal to the other. The left side parameter is null.");
            }
        ...
        log_message_debug("Could not compare if one parameter is greater than or equal to the other. The result parameter is null.");
    }
}
