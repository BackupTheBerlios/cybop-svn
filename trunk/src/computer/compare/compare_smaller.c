 ...
 */
void compare_smaller(const void* p0, const void* p1, const void* p2,
    ...
    if (p21 != NULL_POINTER) {
        ...
        if (p12 != NULL_POINTER) {
            ...
            if (p3 != NULL_POINTER) {
                ...
                log_message_debug("Compare if one parameter is smaller than the other.");
                ...
                if (r == 1) {
                    ...
                    log_message_debug("Could not compare if one parameter is smaller than the other. The result parameter is not a boolean.");
                }

            } else {

                log_message_debug("Could not compare if one parameter is smaller than the other. The left side parameter is null.");
            }

        } else {

            log_message_debug("Could not compare if one parameter is smaller than the other. The right side parameter is null.");
        }

    } else {

        log_message_debug("Could not compare if one parameter is smaller than the other. The result parameter is null.");
    }
}
