...
/**
 * This class represents an ok button.
 *
 * @version $Revision: 1.1 $ $Date: 2003-02-19 07:49:23 $ $Author: christian $
 * @author Christian Heller <christian.heller@tuxtax.de>
 */
public class OkButton extends PanelButton {
    ...
    /** The ok action. */
    public static final String OK_ACTION = new String("ok_action");
    ...
    public Integer getDefaultMnemonic() {
        ...
        return new Integer(java.awt.event.KeyEvent.VK_O);
    }
