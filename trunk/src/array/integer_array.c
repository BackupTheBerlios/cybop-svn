 ...
 */
void copy_integer_array(const void* p0, const void* p1, const void* p2, void* p3, void* p4, void* p5) {
...
//??                        log_message((void*) &ERROR_LOG_LEVEL, (void*) &COULD_NOT_COPY_INTEGER_ARRAY_THE_SOURCE_ARRAY_SIZE_IS_NULL_MESSAGE, (void*) &COULD_NOT_COPY_INTEGER_ARRAY_THE_SOURCE_ARRAY_SIZE_IS_NULL_MESSAGE_COUNT);
                    }

                } else {

//??                    log_message((void*) &ERROR_LOG_LEVEL, (void*) &COULD_NOT_COPY_INTEGER_ARRAY_THE_SOURCE_ARRAY_COUNT_IS_NULL_MESSAGE, (void*) &COULD_NOT_COPY_INTEGER_ARRAY_THE_SOURCE_ARRAY_COUNT_IS_NULL_MESSAGE_COUNT);
                }
...
//??            log_message((void*) &ERROR_LOG_LEVEL, (void*) &COULD_NOT_COPY_INTEGER_ARRAY_THE_DESTINATION_ARRAY_SIZE_IS_NULL_MESSAGE, (void*) &COULD_NOT_COPY_INTEGER_ARRAY_THE_DESTINATION_ARRAY_SIZE_IS_NULL_MESSAGE_COUNT);
        }

    } else {

//??        log_message((void*) &ERROR_LOG_LEVEL, (void*) &COULD_NOT_COPY_INTEGER_ARRAY_THE_DESTINATION_ARRAY_COUNT_IS_NULL_MESSAGE, (void*) &COULD_NOT_COPY_INTEGER_ARRAY_THE_DESTINATION_ARRAY_COUNT_IS_NULL_MESSAGE_COUNT);
    }
}
...
void get_integer_array_elements(const void* p0, const void* p1, void* p2, const void* p3) {
    ...
    if (p3 != NULL_POINTER) {
        ...
        log_message((void*) &ERROR_LOG_LEVEL, (void*) &COULD_NOT_GET_INTEGER_ARRAY_ELEMENTS_THE_COUNT_IS_NULL_MESSAGE, (void*) &COULD_NOT_GET_INTEGER_ARRAY_ELEMENTS_THE_COUNT_IS_NULL_MESSAGE_COUNT);
    }
}
    ...
    if (p4 != NULL_POINTER) {
        ...
        if (p3 != NULL_POINTER) {
            ...
            if (p2 != NULL_POINTER) {
                ...
                log_message((void*) &ERROR_LOG_LEVEL, (void*) &COULD_NOT_GET_INTEGER_ARRAY_ELEMENT_INDEX_THE_COMPARISON_ARRAY_IS_NULL_MESSAGE, (void*) &COULD_NOT_GET_INTEGER_ARRAY_ELEMENT_INDEX_THE_COMPARISON_ARRAY_IS_NULL_MESSAGE_COUNT);
            }
