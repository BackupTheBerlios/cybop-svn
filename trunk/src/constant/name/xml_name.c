 ...
 *
 * @version $RCSfile: xml_name.c,v $ $Revision: 1.1 $ $Date: 2008-09-03 22:04:01 $ $Author: christian $
...
static int* BEGIN_COMMENT_TAG_XML_NAME_COUNT = NUMBER_4_INTEGER_ARRAY;
...
static int* END_COMMENT_TAG_XML_NAME_COUNT = NUMBER_4_INTEGER_ARRAY;
...
static int* SHORT_END_COMMENT_TAG_XML_NAME_COUNT = NUMBER_3_INTEGER_ARRAY;
...
static int* BEGIN_TAG_BEGIN_XML_NAME_COUNT = NUMBER_1_INTEGER_ARRAY;
...
static int* END_TAG_BEGIN_XML_NAME_COUNT = NUMBER_2_INTEGER_ARRAY;

/** The tag end xml name. */
static wchar_t TAG_END_XML_NAME_ARRAY[] = {L'>'};
static wchar_t* TAG_END_XML_NAME = TAG_END_XML_NAME_ARRAY;
static int* TAG_END_XML_NAME_COUNT = NUMBER_1_INTEGER_ARRAY;
...
static int* EMPTY_TAG_END_XML_NAME_COUNT = NUMBER_2_INTEGER_ARRAY;
...
static int* ATTRIBUTE_BEGIN_XML_NAME_COUNT = NUMBER_1_INTEGER_ARRAY;
...
static int* ATTRIBUTE_VALUE_BEGIN_XML_NAME_COUNT = NUMBER_1_INTEGER_ARRAY;
...
static int* ATTRIBUTE_VALUE_END_XML_NAME_COUNT = NUMBER_1_INTEGER_ARRAY;
