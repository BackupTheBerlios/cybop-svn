 ...
 *
 * @version $RCSfile: copy_file_operation_cybol_name.c,v $ $Revision: 1.2 $ $Date: 2009-01-31 16:06:30 $ $Author: christian $
 * @author Christian Heller <christian.heller@tuxtax.de>
 */

#ifndef COPY_FILE_OPERATION_CYBOL_NAME_SOURCE
#define COPY_FILE_OPERATION_CYBOL_NAME_SOURCE
...
static int* RECURSIVE_COPY_FILE_OPERATION_CYBOL_NAME_COUNT = NUMBER_9_INTEGER_MEMORY_MODEL_ARRAY;
...
static int* SOURCE_COPY_FILE_OPERATION_CYBOL_NAME_COUNT = NUMBER_6_INTEGER_MEMORY_MODEL_ARRAY;
...
static int* DESTINATION_COPY_FILE_OPERATION_CYBOL_NAME_COUNT = NUMBER_11_INTEGER_MEMORY_MODEL_ARRAY;

/* COPY_FILE_OPERATION_CYBOL_NAME_SOURCE */
#endif
