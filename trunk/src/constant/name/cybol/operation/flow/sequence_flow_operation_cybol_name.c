 ...
 *
 * @version $RCSfile: loop_flow_operation_cybol_name.c,v $ $Revision: 1.4 $ $Date: 2009-01-31 16:06:30 $ $Author: christian $
 * @author Christian Heller <christian.heller@tuxtax.de>
 */

#ifndef SEQUENCE_FLOW_OPERATION_CYBOL_NAME_SOURCE
#define SEQUENCE_FLOW_OPERATION_CYBOL_NAME_SOURCE
...
/* SEQUENCE_FLOW_OPERATION_CYBOL_NAME_SOURCE */
#endif
