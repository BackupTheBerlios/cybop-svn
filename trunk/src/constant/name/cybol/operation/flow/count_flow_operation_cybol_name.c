 ...
 *
 * @version $RCSfile: count_flow_operation_cybol_name.c,v $ $Revision: 1.1 $ $Date: 2008-09-03 22:04:01 $ $Author: christian $
...
static wchar_t COMPOUND_COUNT_FLOW_OPERATION_CYBOL_NAME_ARRAY[] = {L'c', L'o', L'm', L'p', L'o', L'u', L'n', L'd'};
static wchar_t* COMPOUND_COUNT_FLOW_OPERATION_CYBOL_NAME = COMPOUND_COUNT_FLOW_OPERATION_CYBOL_NAME_ARRAY;
static int* COMPOUND_COUNT_FLOW_OPERATION_CYBOL_NAME_COUNT = NUMBER_8_INTEGER_ARRAY;
...
static int* SELECTION_COUNT_FLOW_OPERATION_CYBOL_NAME_COUNT = NUMBER_9_INTEGER_ARRAY;
...
static int* FILTER_COUNT_FLOW_OPERATION_CYBOL_NAME_COUNT = NUMBER_6_INTEGER_ARRAY;
...
static int* RESULT_COUNT_FLOW_OPERATION_CYBOL_NAME_COUNT = NUMBER_6_INTEGER_ARRAY;
