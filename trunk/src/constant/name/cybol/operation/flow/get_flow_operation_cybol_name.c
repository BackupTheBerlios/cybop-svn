 ...
 *
 * @version $RCSfile: get_flow_operation_cybol_name.c,v $ $Revision: 1.1 $ $Date: 2008-09-03 22:04:01 $ $Author: christian $
...
static int* COMPOUND_GET_FLOW_OPERATION_CYBOL_NAME_COUNT = NUMBER_8_INTEGER_ARRAY;
...
static int* INDEX_GET_FLOW_OPERATION_CYBOL_NAME_COUNT = NUMBER_5_INTEGER_ARRAY;
...
static int* DESCRIPTION_GET_FLOW_OPERATION_CYBOL_NAME_COUNT = NUMBER_11_INTEGER_ARRAY;
...
static int* RESULT_GET_FLOW_OPERATION_CYBOL_NAME_COUNT = NUMBER_6_INTEGER_ARRAY;
