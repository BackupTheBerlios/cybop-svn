 ...
 *
 * @version $RCSfile: header_http_name.c,v $ $Revision: 1.1 $ $Date: 2008-09-03 22:04:01 $ $Author: christian $
...
static int* CONTENT_TYPE_HEADER_HTTP_NAME_COUNT = NUMBER_12_INTEGER_ARRAY;
...
static int* CONTENT_LANGUAGE_HEADER_HTTP_NAME_COUNT = NUMBER_16_INTEGER_ARRAY;
...
static int* CONTENT_ENCODING_HEADER_HTTP_NAME_COUNT = NUMBER_16_INTEGER_ARRAY;
...
static int* CONTENT_LENGTH_HEADER_HTTP_NAME_COUNT = NUMBER_14_INTEGER_ARRAY;
...
static int* DATE_HEADER_HTTP_NAME_COUNT = NUMBER_4_INTEGER_ARRAY;
...
static int* LAST_MODIFIED_HEADER_HTTP_NAME_COUNT = NUMBER_13_INTEGER_ARRAY;
...
static int* SET_COOKIE_HEADER_HTTP_NAME_COUNT = NUMBER_10_INTEGER_ARRAY;
