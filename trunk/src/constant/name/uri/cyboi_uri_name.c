...
/** The cyboi authority username uri name. */
static wchar_t CYBOI_AUTHORITY_USERNAME_URI_NAME_ARRAY[] = {L'u', L's', L'e', L'r', L'n', L'a', L'm', L'e'};
static wchar_t* CYBOI_AUTHORITY_USERNAME_URI_NAME = CYBOI_AUTHORITY_USERNAME_URI_NAME_ARRAY;
static int* CYBOI_AUTHORITY_USERNAME_URI_NAME_COUNT = NUMBER_8_INTEGER_MEMORY_MODEL_ARRAY;

/** The cyboi authority password uri name. */
static wchar_t CYBOI_AUTHORITY_PASSWORD_URI_NAME_ARRAY[] = {L'p', L'a', L's', L's', L'w', L'o', L'r', L'd'};
static wchar_t* CYBOI_AUTHORITY_PASSWORD_URI_NAME = CYBOI_AUTHORITY_PASSWORD_URI_NAME_ARRAY;
static int* CYBOI_AUTHORITY_PASSWORD_URI_NAME_COUNT = NUMBER_8_INTEGER_MEMORY_MODEL_ARRAY;

/** The cyboi authority hostname uri name. */
static wchar_t CYBOI_AUTHORITY_HOSTNAME_URI_NAME_ARRAY[] = {L'h', L'o', L's', L't', L'n', L'a', L'm', L'e'};
static wchar_t* CYBOI_AUTHORITY_HOSTNAME_URI_NAME = CYBOI_AUTHORITY_HOSTNAME_URI_NAME_ARRAY;
static int* CYBOI_AUTHORITY_HOSTNAME_URI_NAME_COUNT = NUMBER_8_INTEGER_MEMORY_MODEL_ARRAY;

/** The cyboi authority port uri name. */
static wchar_t CYBOI_AUTHORITY_PORT_URI_NAME_ARRAY[] = {L'p', L'o', L'r', L't'};
static wchar_t* CYBOI_AUTHORITY_PORT_URI_NAME = CYBOI_AUTHORITY_PORT_URI_NAME_ARRAY;
static int* CYBOI_AUTHORITY_PORT_URI_NAME_COUNT = NUMBER_4_INTEGER_MEMORY_MODEL_ARRAY;
