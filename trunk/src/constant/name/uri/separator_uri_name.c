...
/** The authority password begin (solidus, solidus) separator uri name. */
static wchar_t* AUTHORITY_PASSWORD_BEGIN_SEPARATOR_URI_NAME = COLON_UNICODE_CHARACTER_CODE_MODEL_ARRAY;
static int* AUTHORITY_PASSWORD_BEGIN_SEPARATOR_URI_NAME_COUNT = NUMBER_1_INTEGER_MEMORY_MODEL_ARRAY;

/** The authority userinfo end (commercial at) separator uri name. */
static wchar_t* AUTHORITY_USERINFO_END_SEPARATOR_URI_NAME = COMMERCIAL_AT_UNICODE_CHARACTER_CODE_MODEL_ARRAY;
static int* AUTHORITY_USERINFO_END_SEPARATOR_URI_NAME_COUNT = NUMBER_1_INTEGER_MEMORY_MODEL_ARRAY;

/** The port begin (colon) separator uri name. */
static wchar_t* PORT_BEGIN_SEPARATOR_URI_NAME = COLON_UNICODE_CHARACTER_CODE_MODEL_ARRAY;
static int* PORT_BEGIN_SEPARATOR_URI_NAME_COUNT = NUMBER_1_INTEGER_MEMORY_MODEL_ARRAY;
