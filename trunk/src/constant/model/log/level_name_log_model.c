 ...
 *
 * @version $RCSfile: level_name_log_model.c,v $ $Revision: 1.1 $ $Date: 2008-09-03 22:04:01 $ $Author: christian $
...
static int* ERROR_LEVEL_NAME_LOG_MODEL_COUNT = NUMBER_5_INTEGER_ARRAY;
...
static int* WARNING_LEVEL_NAME_LOG_MODEL_COUNT = NUMBER_7_INTEGER_ARRAY;
...
static int* INFORMATION_LEVEL_NAME_LOG_MODEL_COUNT = NUMBER_11_INTEGER_ARRAY;
...
static int* DEBUG_LEVEL_NAME_LOG_MODEL_COUNT = NUMBER_5_INTEGER_ARRAY;
