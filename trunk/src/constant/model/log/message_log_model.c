 ...
 *
 * @version $RCSfile: message_log_model.c,v $ $Revision: 1.3 $ $Date: 2008-09-06 23:17:20 $ $Author: christian $
...
static wchar_t HANDLE_OPERATION_MESSAGE_LOG_MODEL_LOG_MODEL_ARRAY[] = {L'H', L'a', L'n', L'd', L'l', L'e', L' ', L'o', L'p', L'e', L'r', L'a', L't', L'i', L'o', L'n', L'.'};
static wchar_t* HANDLE_OPERATION_MESSAGE_LOG_MODEL_LOG_MODEL = HANDLE_OPERATION_MESSAGE_LOG_MODEL_LOG_MODEL_ARRAY;
static int* HANDLE_OPERATION_MESSAGE_LOG_MODEL_LOG_MODEL_COUNT = NUMBER_17_INTEGER_MEMORY_MODEL_ARRAY;
