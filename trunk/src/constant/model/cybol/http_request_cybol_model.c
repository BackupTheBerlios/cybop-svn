 ...
 *
 * @version $RCSfile: http_request_cybol_model.c,v $ $Revision: 1.1 $ $Date: 2008-09-03 22:04:00 $ $Author: christian $
...
static int* GET_HTTP_REQUEST_CYBOL_MODEL_COUNT = NUMBER_3_INTEGER_ARRAY;
...
static int* POST_HTTP_REQUEST_CYBOL_MODEL_COUNT = NUMBER_4_INTEGER_ARRAY;
...
static int* HEAD_HTTP_REQUEST_CYBOL_MODEL_COUNT = NUMBER_4_INTEGER_ARRAY;
...
static int* PUT_HTTP_REQUEST_CYBOL_MODEL_COUNT = NUMBER_3_INTEGER_ARRAY;
...
static int* DELETE_HTTP_REQUEST_CYBOL_MODEL_COUNT = NUMBER_6_INTEGER_ARRAY;
...
static int* TRACE_HTTP_REQUEST_CYBOL_MODEL_COUNT = NUMBER_5_INTEGER_ARRAY;
...
static int* OPTIONS_HTTP_REQUEST_CYBOL_MODEL_COUNT = NUMBER_7_INTEGER_ARRAY;
...
static int* CONNECT_HTTP_REQUEST_CYBOL_MODEL_COUNT = NUMBER_7_INTEGER_ARRAY;
...
static int* PROPFIND_WEBDAV_HTTP_REQUEST_CYBOL_MODEL_COUNT = NUMBER_8_INTEGER_ARRAY;
...
static int* PROPPATCH_WEBDAV_HTTP_REQUEST_CYBOL_MODEL_COUNT = NUMBER_9_INTEGER_ARRAY;
...
static int* MKCOL_WEBDAV_HTTP_REQUEST_CYBOL_MODEL_COUNT = NUMBER_5_INTEGER_ARRAY;
...
static int* COPY_WEBDAV_HTTP_REQUEST_CYBOL_MODEL_COUNT = NUMBER_4_INTEGER_ARRAY;
...
static int* MOVE_WEBDAV_HTTP_REQUEST_CYBOL_MODEL_COUNT = NUMBER_4_INTEGER_ARRAY;
...
static int* LOCK_WEBDAV_HTTP_REQUEST_CYBOL_MODEL_COUNT = NUMBER_4_INTEGER_ARRAY;
...
static int* UNLOCK_WEBDAV_HTTP_REQUEST_CYBOL_MODEL_COUNT = NUMBER_6_INTEGER_ARRAY;
