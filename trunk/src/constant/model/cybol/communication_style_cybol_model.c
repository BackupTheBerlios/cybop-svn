 ...
 *
 * @version $RCSfile: communication_style_cybol_model.c,v $ $Revision: 1.3 $ $Date: 2008-10-25 23:20:04 $ $Author: christian $
...
static int* STREAM_COMMUNICATION_STYLE_CYBOL_MODEL_COUNT = NUMBER_6_INTEGER_MEMORY_MODEL_ARRAY;
...
static int* DATAGRAM_COMMUNICATION_STYLE_CYBOL_MODEL_COUNT = NUMBER_8_INTEGER_MEMORY_MODEL_ARRAY;
...
static int* RAW_COMMUNICATION_STYLE_CYBOL_MODEL_COUNT = NUMBER_3_INTEGER_MEMORY_MODEL_ARRAY;
