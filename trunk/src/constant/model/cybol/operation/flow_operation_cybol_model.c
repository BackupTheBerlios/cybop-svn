 ...
 *
 * @version $RCSfile: flow_operation_cybol_model.c,v $ $Revision: 1.2 $ $Date: 2008-09-04 20:31:30 $ $Author: christian $
...
static int* COUNT_FLOW_OPERATION_CYBOL_MODEL_COUNT = NUMBER_5_INTEGER_MEMORY_MODEL_ARRAY;
...
static int* BUILD_LISTNAME_FLOW_OPERATION_CYBOL_MODEL_COUNT = NUMBER_14_INTEGER_MEMORY_MODEL_ARRAY;
...
static int* GET_FLOW_OPERATION_CYBOL_MODEL_COUNT = NUMBER_3_INTEGER_MEMORY_MODEL_ARRAY;
