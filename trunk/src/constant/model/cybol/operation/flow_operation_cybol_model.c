 ...
 *
 * @version $RCSfile: flow_operation_cybol_model.c,v $ $Revision: 1.5 $ $Date: 2009-01-31 16:06:30 $ $Author: christian $
...
/** The sequence flow operation cybol model. */
static wchar_t SEQUENCE_FLOW_OPERATION_CYBOL_MODEL_ARRAY[] = {L's', L'e', L'q', L'u', L'e', L'n', L'c', L'e'};
static wchar_t* SEQUENCE_FLOW_OPERATION_CYBOL_MODEL = SEQUENCE_FLOW_OPERATION_CYBOL_MODEL_ARRAY;
static int* SEQUENCE_FLOW_OPERATION_CYBOL_MODEL_COUNT = NUMBER_8_INTEGER_MEMORY_MODEL_ARRAY;
