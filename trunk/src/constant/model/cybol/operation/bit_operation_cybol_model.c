 ...
 *
 * @version $RCSfile: bit_operation_cybol_model.c,v $ $Revision: 1.1 $ $Date: 2008-09-03 22:04:01 $ $Author: christian $
...
static int* SHIFT_LEFT_BIT_OPERATION_CYBOL_MODEL_COUNT = NUMBER_10_INTEGER_ARRAY;
...
static int* SHIFT_RIGHT_BIT_OPERATION_CYBOL_MODEL_COUNT = NUMBER_11_INTEGER_ARRAY;
...
static int* ROTATE_LEFT_BIT_OPERATION_CYBOL_MODEL_COUNT = NUMBER_11_INTEGER_ARRAY;
...
static int* ROTATE_RIGHT_BIT_OPERATION_CYBOL_MODEL_COUNT = NUMBER_12_INTEGER_ARRAY;
...
static int* SET_BIT_OPERATION_CYBOL_MODEL_COUNT = NUMBER_7_INTEGER_ARRAY;
...
static int* RESET_BIT_OPERATION_CYBOL_MODEL_COUNT = NUMBER_9_INTEGER_ARRAY;
...
static int* GET_BIT_OPERATION_CYBOL_MODEL_COUNT = NUMBER_7_INTEGER_ARRAY;
