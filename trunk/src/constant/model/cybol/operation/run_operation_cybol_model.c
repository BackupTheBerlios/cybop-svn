 ...
 *
 * @version $RCSfile: run_operation_cybol_model.c,v $ $Revision: 1.1 $ $Date: 2008-09-03 22:04:01 $ $Author: christian $
...
static int* ARCHIVE_RUN_OPERATION_CYBOL_MODEL_COUNT = NUMBER_7_INTEGER_ARRAY;
...
static int* COPY_RUN_OPERATION_CYBOL_MODEL_COUNT = NUMBER_4_INTEGER_ARRAY;
...
static int* LIST_DIRECTORY_CONTENTS_RUN_OPERATION_CYBOL_MODEL_COUNT = NUMBER_23_INTEGER_ARRAY;
...
static int* PROGRAM_RUN_OPERATION_CYBOL_MODEL_COUNT = NUMBER_7_INTEGER_ARRAY;
