 ...
 *
 * @version $RCSfile: service_cybol_model.c,v $ $Revision: 1.1 $ $Date: 2008-09-03 22:04:01 $ $Author: christian $
...
static int* SIGNAL_SERVICE_CYBOL_MODEL_COUNT = NUMBER_6_INTEGER_ARRAY;
...
static int* SHELL_SERVICE_CYBOL_MODEL_COUNT = NUMBER_5_INTEGER_ARRAY;
...
static int* STANDARD_OUTPUT_SERVICE_CYBOL_MODEL_COUNT = NUMBER_15_INTEGER_ARRAY;
...
static int* GNU_LINUX_CONSOLE_SERVICE_CYBOL_MODEL_COUNT = NUMBER_17_INTEGER_ARRAY;
...
static int* X_WINDOW_SYSTEM_SERVICE_CYBOL_MODEL_COUNT = NUMBER_15_INTEGER_ARRAY;
...
static int* WWW_SERVICE_CYBOL_MODEL_COUNT = NUMBER_3_INTEGER_ARRAY;
...
static int* CYBOI_SERVICE_CYBOL_MODEL_COUNT = NUMBER_5_INTEGER_ARRAY;
