...
/** The subsequence comparison selection cybol model. */
static wchar_t SUBSEQUENCE_COMPARISON_SELECTION_CYBOL_MODEL_ARRAY[] = {L's', L'u', L'b', L's', L'e', L'q', L'u', L'e', L'n', L'c', L'e'};
static wchar_t* SUBSEQUENCE_COMPARISON_SELECTION_CYBOL_MODEL = SUBSEQUENCE_COMPARISON_SELECTION_CYBOL_MODEL_ARRAY;
static int* SUBSEQUENCE_COMPARISON_SELECTION_CYBOL_MODEL_COUNT = NUMBER_11_INTEGER_MEMORY_MODEL_ARRAY;
