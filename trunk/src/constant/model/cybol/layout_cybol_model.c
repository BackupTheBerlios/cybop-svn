 ...
 *
 * @version $RCSfile: layout_cybol_model.c,v $ $Revision: 1.1 $ $Date: 2008-09-03 22:04:01 $ $Author: christian $
...
static int* ROOT_LAYOUT_CYBOL_MODEL_COUNT = NUMBER_4_INTEGER_ARRAY;
...
static int* COORDINATES_LAYOUT_CYBOL_MODEL_COUNT = NUMBER_11_INTEGER_ARRAY;
...
static int* COMPASS_LAYOUT_CYBOL_MODEL_COUNT = NUMBER_7_INTEGER_ARRAY;
