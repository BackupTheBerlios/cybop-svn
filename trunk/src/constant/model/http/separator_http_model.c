 ...
 *
 * @version $RCSfile: separator_http_model.c,v $ $Revision: 1.1 $ $Date: 2008-09-03 22:04:01 $ $Author: christian $
...
static int* REQUEST_LINE_SEPARATOR_HTTP_MODEL_COUNT = NUMBER_2_INTEGER_ARRAY;
...
static int* RESPONSE_LINE_SEPARATOR_HTTP_MODEL_COUNT = NUMBER_2_INTEGER_ARRAY;
...
static int* HEADERS_SEPARATOR_HTTP_MODEL_COUNT = NUMBER_4_INTEGER_ARRAY;
...
static int* BODY_SEPARATOR_HTTP_MODEL_COUNT = NUMBER_2_INTEGER_ARRAY;
...
static int* REQUEST_METHOD_SEPARATOR_HTTP_MODEL_COUNT = NUMBER_1_INTEGER_ARRAY;
...
static int* UNIFORM_RESOURCE_IDENTIFIER_SEPARATOR_HTTP_MODEL_COUNT = NUMBER_1_INTEGER_ARRAY;
...
static int* PROTOCOL_VERSION_SEPARATOR_HTTP_MODEL_COUNT = NUMBER_1_INTEGER_ARRAY;
...
static int* HEADER_ARGUMENT_SEPARATOR_HTTP_MODEL_COUNT = NUMBER_2_INTEGER_ARRAY;
...
static int* HEADER_VALUE_SEPARATOR_HTTP_MODEL_COUNT = NUMBER_2_INTEGER_ARRAY;
...
static int* HEADER_VALUE_ASSIGNMENT_SEPARATOR_HTTP_MODEL_COUNT = NUMBER_1_INTEGER_ARRAY;
...
static int* HEADER_SEPARATOR_HTTP_MODEL_COUNT = NUMBER_2_INTEGER_ARRAY;
