 ...
 *
 * @version $RCSfile: escape_code_uri_model.c,v $ $Revision: 1.1 $ $Date: 2008-09-03 22:04:01 $ $Author: christian $
...
static int* SPACE_ESCAPE_CODE_URI_MODEL_COUNT = NUMBER_3_INTEGER_ARRAY;
...
static int* NUMBER_SIGN_ESCAPE_CODE_URI_MODEL_COUNT = NUMBER_3_INTEGER_ARRAY;
...
static int* DOLLAR_SIGN_ESCAPE_CODE_URI_MODEL_COUNT = NUMBER_3_INTEGER_ARRAY;
...
static int* PERCENT_SIGN_ESCAPE_CODE_URI_MODEL_COUNT = NUMBER_3_INTEGER_ARRAY;
...
static int* AMPERSAND_ESCAPE_CODE_URI_MODEL_COUNT = NUMBER_3_INTEGER_ARRAY;
...
static int* SOLIDUS_ESCAPE_CODE_URI_MODEL_COUNT = NUMBER_3_INTEGER_ARRAY;
...
static int* COLON_ESCAPE_CODE_URI_MODEL_COUNT = NUMBER_3_INTEGER_ARRAY;
...
static int* SEMICOLON_ESCAPE_CODE_URI_MODEL_COUNT = NUMBER_3_INTEGER_ARRAY;
...
static int* LESS_THAN_SIGN_ESCAPE_CODE_URI_MODEL_COUNT = NUMBER_3_INTEGER_ARRAY;
...
static int* EQUALS_SIGN_ESCAPE_CODE_URI_MODEL_COUNT = NUMBER_3_INTEGER_ARRAY;
...
static int* GREATER_THAN_SIGN_ESCAPE_CODE_URI_MODEL_COUNT = NUMBER_3_INTEGER_ARRAY;
...
static int* QUESTION_MARK_ESCAPE_CODE_URI_MODEL_COUNT = NUMBER_3_INTEGER_ARRAY;
...
static int* COMMERCIAL_AT_ESCAPE_CODE_URI_MODEL_COUNT = NUMBER_3_INTEGER_ARRAY;
...
static int* LEFT_SQUARE_BRACKET_ESCAPE_CODE_URI_MODEL_COUNT = NUMBER_3_INTEGER_ARRAY;
...
static int* REVERSE_SOLIDUS_ESCAPE_CODE_URI_MODEL_COUNT = NUMBER_3_INTEGER_ARRAY;
...
static int* RIGHT_SQUARE_BRACKET_ESCAPE_CODE_URI_MODEL_COUNT = NUMBER_3_INTEGER_ARRAY;
...
static int* CARET_ESCAPE_CODE_URI_MODEL_COUNT = NUMBER_3_INTEGER_ARRAY;
...
static int* GRAVE_ACCENT_ESCAPE_CODE_URI_MODEL_COUNT = NUMBER_3_INTEGER_ARRAY;
...
static int* LEFT_CURLY_BRACE_ESCAPE_CODE_URI_MODEL_COUNT = NUMBER_3_INTEGER_ARRAY;
...
static int* VERTICAL_BAR_ESCAPE_CODE_URI_MODEL_COUNT = NUMBER_3_INTEGER_ARRAY;
...
static int* RIGHT_CURLY_BRACE_ESCAPE_CODE_URI_MODEL_COUNT = NUMBER_3_INTEGER_ARRAY;
...
static int* TILDE_ESCAPE_CODE_URI_MODEL_COUNT = NUMBER_3_INTEGER_ARRAY;
