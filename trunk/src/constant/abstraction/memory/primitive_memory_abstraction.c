...
static int* POINTER_PRIMITIVE_MEMORY_ABSTRACTION = NUMBER_4_INTEGER_MEMORY_MODEL_ARRAY;

/** The unsigned long primitive memory abstraction. */
static int* UNSIGNED_LONG_PRIMITIVE_MEMORY_ABSTRACTION = NUMBER_5_INTEGER_MEMORY_MODEL_ARRAY;

/** The wide character primitive memory abstraction. */
static int* WIDE_CHARACTER_PRIMITIVE_MEMORY_ABSTRACTION = NUMBER_6_INTEGER_MEMORY_MODEL_ARRAY;
