...
/** The fraction primitive memory abstraction. */
static int* FRACTION_PRIMITIVE_MEMORY_ABSTRACTION = NUMBER_2_INTEGER_MEMORY_MODEL_ARRAY;

/** The integer primitive memory abstraction. */
static int* INTEGER_PRIMITIVE_MEMORY_ABSTRACTION = NUMBER_3_INTEGER_MEMORY_MODEL_ARRAY;

/** The part primitive memory abstraction. */
static int* PART_PRIMITIVE_MEMORY_ABSTRACTION = NUMBER_4_INTEGER_MEMORY_MODEL_ARRAY;

/** The pointer primitive memory abstraction. */
static int* POINTER_PRIMITIVE_MEMORY_ABSTRACTION = NUMBER_5_INTEGER_MEMORY_MODEL_ARRAY;

/** The unsigned long primitive memory abstraction. */
static int* UNSIGNED_LONG_PRIMITIVE_MEMORY_ABSTRACTION = NUMBER_6_INTEGER_MEMORY_MODEL_ARRAY;
