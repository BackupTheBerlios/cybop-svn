 ...
 *
 * @version $RCSfile: print_cybol_abstraction.c,v $ $Revision: 1.1 $ $Date: 2008-09-03 22:04:00 $ $Author: christian $
...
static int* JOBS_PRINT_CYBOL_ABSTRACTION_COUNT = NUMBER_10_INTEGER_ARRAY;
