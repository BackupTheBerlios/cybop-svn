/*
 * $RCSfile: boolean_translator.c,v $
 *
...
#ifndef BOOLEAN_TRANSLATOR_SOURCE
#define BOOLEAN_TRANSLATOR_SOURCE

#include "../global/log_constants.c"
#include "../logger/logger.c"

/**
 * Decodes the boolean model and creates a cyboi boolean from it.
 *
 ...
 */
void decode_boolean(void* p0, void* p1, void* p2, const void* p3, const void* p4) {
...
/**
 * Encodes the cyboi boolean and creates a boolean model from it.
 *
 * @param p0 the destination
 * @param p1 the destination count
 * @param p2 the destination size
 ...
 * @param p4 the source count
 */
void encode_boolean(void* p0, void* p1, void* p2, const void* p3, const void* p4) {
}

/* BOOLEAN_TRANSLATOR_SOURCE */
#endif
