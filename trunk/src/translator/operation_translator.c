/*
 * $RCSfile: operation_translator.c,v $
 *
...
#ifndef OPERATION_TRANSLATOR_SOURCE
#define OPERATION_TRANSLATOR_SOURCE

#include "../global/log_constants.c"
#include "../logger/logger.c"

/**
 * Decodes the operation model and creates a cyboi operation from it.
 *
 ...
 */
void decode_operation(void* p0, void* p1, void* p2, const void* p3, const void* p4) {
    ...
    if (p4 != NULL_POINTER) {
        ...
        if (p3 != NULL_POINTER) {
            ...
            if (p0 != NULL_POINTER) {
                ...
                //?? Copy the operation with all parameters!
...
/**
 * Encodes the cyboi operation and creates an operation model from it.
 *
 * @param p0 the destination
 * @param p1 the destination count
 * @param p2 the destination size
 ...
 * @param p4 the source count
 */
void encode_operation(void* p0, void* p1, void* p2, const void* p3, const void* p4) {
}

/* OPERATION_TRANSLATOR_SOURCE */
#endif
