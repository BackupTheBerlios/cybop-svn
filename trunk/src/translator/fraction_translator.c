/*
 * $RCSfile: fraction_translator.c,v $
 *
...
#ifndef FRACTION_TRANSLATOR_SOURCE
#define FRACTION_TRANSLATOR_SOURCE

#include "../global/log_constants.c"
#include "../logger/logger.c"

/**
 * Decodes the fraction model and creates a cyboi fraction from it.
 *
 ...
 */
void decode_fraction(void* p0, void* p1, void* p2, const void* p3, const void* p4) {
    ...
    if (p4 != NULL_POINTER) {
        ...
        if (p3 != NULL_POINTER) {
            ...
            if (p0 != NULL_POINTER) {
                ...
                //?? Copy the fraction with all fields!
...
/**
 * Encodes the cyboi fraction and creates a fraction model from it.
 *
 * @param p0 the destination
 * @param p1 the destination count
 * @param p2 the destination size
 ...
 * @param p4 the source count
 */
void encode_fraction(void* p0, void* p1, void* p2, const void* p3, const void* p4) {
}

/* FRACTION_TRANSLATOR_SOURCE */
#endif
