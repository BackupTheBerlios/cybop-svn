/*
 * $RCSfile: compound_translator.c,v $
 *
...
#ifndef COMPOUND_TRANSLATOR_SOURCE
#define COMPOUND_TRANSLATOR_SOURCE

#include "../global/log_constants.c"
#include "../logger/logger.c"

/**
 * Decodes the compound model and creates a compound integer from it.
 *
 ...
 */
void decode_compound(void* p0, void* p1, void* p2, const void* p3, const void* p4) {
    ...
    if (p4 != NULL_POINTER) {
        ...
        if (p3 != NULL_POINTER) {
            ...
            if (p0 != NULL_POINTER) {
                ...
                //?? Translate the XML DOM tree into a CYBOI compound!
...
/**
 * Encodes the cyboi compound and creates a compound model from it.
 *
 * @param p0 the destination
 * @param p1 the destination count
 * @param p2 the destination size
 ...
 * @param p4 the source count
 */
void encode_compound(void* p0, void* p1, void* p2, const void* p3, const void* p4) {
}

/* COMPOUND_TRANSLATOR_SOURCE */
#endif
