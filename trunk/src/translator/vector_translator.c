...
#ifndef VECTOR_TRANSLATOR_SOURCE
#define VECTOR_TRANSLATOR_SOURCE

#include "../global/log_constants.c"
#include "../logger/logger.c"

/**
 * Decodes the vector model and creates a cyboi vector from it.
 *
 ...
 */
void decode_vector(void* p0, void* p1, void* p2, const void* p3, const void* p4) {
    ...
    if (p4 != NULL_POINTER) {
        ...
        if (p3 != NULL_POINTER) {
            ...
            if (p0 != NULL_POINTER) {
                ...
                //?? Copy the vector with all its fields!
...
/**
 * Encodes the cyboi vector and creates a vector model from it.
 *
 * @param p0 the destination
 * @param p1 the destination count
 * @param p2 the destination size
 ...
 * @param p4 the source count
 */
void encode_vector(void* p0, void* p1, void* p2, const void* p3, const void* p4) {
}

/* VECTOR_TRANSLATOR_SOURCE */
#endif
