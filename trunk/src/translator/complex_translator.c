/*
 * $RCSfile: complex_translator.c,v $
 *
...
#ifndef COMPLEX_TRANSLATOR_SOURCE
#define COMPLEX_TRANSLATOR_SOURCE

#include "../global/log_constants.c"
#include "../logger/logger.c"

/**
 * Decodes the complex model and creates a cyboi complex from it.
 *
 ...
 */
void decode_complex(void* p0, void* p1, void* p2, const void* p3, const void* p4) {
...
/**
 * Encodes the cyboi complex and creates a complex model from it.
 *
 * @param p0 the destination
 * @param p1 the destination count
 * @param p2 the destination size
 ...
 * @param p4 the source count
 */
void encode_complex(void* p0, void* p1, void* p2, const void* p3, const void* p4) {
}

/* COMPLEX_TRANSLATOR_SOURCE */
#endif
