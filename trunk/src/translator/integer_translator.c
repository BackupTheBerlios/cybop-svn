/*
 * $RCSfile: integer_translator.c,v $
 *
...
#ifndef INTEGER_TRANSLATOR_SOURCE
#define INTEGER_TRANSLATOR_SOURCE

#include "../global/log_constants.c"
#include "../logger/logger.c"

/**
 * Decodes the integer model and creates a cyboi integer from it.
 *
 ...
 */
void decode_integer(void* p0, void* p1, void* p2, const void* p3, const void* p4) {
...
/**
 * Encodes the cyboi integer and creates an integer model from it.
 *
 * @param p0 the destination
 * @param p1 the destination count
 * @param p2 the destination size
 ...
 * @param p4 the source count
 */
void encode_integer(void* p0, void* p1, void* p2, const void* p3, const void* p4) {
}

/* INTEGER_TRANSLATOR_SOURCE */
#endif
