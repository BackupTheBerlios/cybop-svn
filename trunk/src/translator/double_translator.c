...
#ifndef DOUBLE_TRANSLATOR_SOURCE
#define DOUBLE_TRANSLATOR_SOURCE

#include "../global/log_constants.c"
#include "../logger/logger.c"

/**
 * Decodes the double model and creates a cyboi double from it.
 *
 ...
 */
void decode_double(void* p0, void* p1, void* p2, const void* p3, const void* p4) {
...
/**
 * Encodes the cyboi double and creates a double model from it.
 *
 * @param p0 the destination
 * @param p1 the destination count
 * @param p2 the destination size
 ...
 * @param p4 the source count
 */
void encode_double(void* p0, void* p1, void* p2, const void* p3, const void* p4) {
}

/* DOUBLE_TRANSLATOR_SOURCE */
#endif
