...
/**
 * This is the pointer array handler.
 *
 ...
 *
 * @version $Revision: 1.1 $ $Date: 2004-03-10 18:06:38 $ $Author: christian $
...
void remove_pointer_array_element(const void* p0, const void* p1, const void* p2) {
    ...
    if (c != (void*) 0) {
        ...
        log_message((void*) &ERROR_LOG_LEVEL, "Could not remove pointer array element. The count is null.");
    }
}
