 ...
 *
 * @version $Revision: 1.34 $ $Date: 2005-04-13 11:26:43 $ $Author: rholzmueller $
...
/**
 * create a signal in the signal memory
 ...
 */
void create_signal(const void* p0, const void* p1,
    const void* p2, const void* p3, const void* p4, 
    void* p5, const void* p6) {

    log_message_debug("create signal.");
