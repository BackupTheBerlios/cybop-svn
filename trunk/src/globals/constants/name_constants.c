...
static const int* TAG_NAME_COUNT = NUMBER_3_INTEGER_ARRAY;

/** Property name. */
static const char PROPERTY_NAME_ARRAY[] = {'p', 'r', 'o', 'p', 'e', 'r', 't', 'y'};
static const char* PROPERTY_NAME = PROPERTY_NAME_ARRAY;
static const int* PROPERTY_NAME_COUNT = NUMBER_8_INTEGER_ARRAY;
...
static const int* OPERAND_1_NAME_COUNT = NUMBER_9_INTEGER_ARRAY;

/** The operand 2 name. */
static const char OPERAND_2_NAME_ARRAY[] = {'o', 'p', 'e', 'r', 'a', 'n', 'd', '_', '2'};
static const char* OPERAND_2_NAME = OPERAND_2_NAME_ARRAY;
static const int* OPERAND_2_NAME_COUNT = NUMBER_9_INTEGER_ARRAY;
...
static const int* RESULT_OPERAND_NAME_COUNT = NUMBER_6_INTEGER_ARRAY;
...
static const int* SOURCE_NAME_COUNT = NUMBER_6_INTEGER_ARRAY;
...
static const int* DESTINATION_NAME_COUNT = NUMBER_11_INTEGER_ARRAY;
...
static const int* DESTINATION_PROPERTY_NAME_COUNT = NUMBER_20_INTEGER_ARRAY;
...
static const int* CRITERION_NAME_COUNT = NUMBER_9_INTEGER_ARRAY;

/** The true model name. */
static const char TRUE_MODEL_NAME_ARRAY[] = {'t', 'r', 'u', 'e', '_', 'm', 'o', 'd', 'e', 'l'};
static const char* TRUE_MODEL_NAME = TRUE_MODEL_NAME_ARRAY;
static const int* TRUE_MODEL_NAME_COUNT = NUMBER_10_INTEGER_ARRAY;
...
static const int* FALSE_MODEL_NAME_COUNT = NUMBER_11_INTEGER_ARRAY;
...
static const int* BREAK_FLAG_NAME_COUNT = NUMBER_5_INTEGER_ARRAY;

/** The loop model name. */
static const char LOOP_MODEL_NAME_ARRAY[] = {'m', 'o', 'd', 'e', 'l'};
static const char* LOOP_MODEL_NAME = LOOP_MODEL_NAME_ARRAY;
static const int* LOOP_MODEL_NAME_COUNT = NUMBER_5_INTEGER_ARRAY;
...
static const int* BASE_NAME_NAME_COUNT = NUMBER_4_INTEGER_ARRAY;

/** The index name name. */
static const char INDEX_NAME_NAME_ARRAY[] = {'i', 'n', 'd', 'e', 'x'};
static const char* INDEX_NAME_NAME = INDEX_NAME_NAME_ARRAY;
static const int* INDEX_NAME_NAME_COUNT = NUMBER_5_INTEGER_ARRAY;
...
static const int* COMPOSED_NAME_NAME_COUNT = NUMBER_8_INTEGER_ARRAY;
...
static const int* NAME_NAME_COUNT = NUMBER_4_INTEGER_ARRAY;

/** The channel name. */
static const char CHANNEL_NAME_ARRAY[] = {'c', 'h', 'a', 'n', 'n', 'e', 'l'};
static const char* CHANNEL_NAME = CHANNEL_NAME_ARRAY;
static const int* CHANNEL_NAME_COUNT = NUMBER_7_INTEGER_ARRAY;
