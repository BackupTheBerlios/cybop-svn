 ...
 *
 * @version $Revision: 1.17 $ $Date: 2005-10-07 12:20:55 $ $Author: christian $
...
static int* UNIX_SERVER_SOCKET_ACTIVE_INTERNAL = NUMBER_100_INTEGER_ARRAY;
static int* UNIX_SERVER_SOCKET_INTERNAL = NUMBER_101_INTEGER_ARRAY;
static int* UNIX_SERVER_SOCKET_FILENAME_INTERNAL = NUMBER_102_INTEGER_ARRAY;
/** The tcp server socket. */
static int* TCP_SERVER_SOCKET_ACTIVE_INTERNAL = NUMBER_103_INTEGER_ARRAY;
static int* TCP_SERVER_SOCKET_INTERNAL = NUMBER_104_INTEGER_ARRAY;
static int* TCP_SERVER_SOCKET_BLOCKING_INTERNAL = NUMBER_105_INTEGER_ARRAY;
...
/** The linux console. */
static int* TERMINAL_FILE_DESCRIPTOR_INTERNAL = NUMBER_200_INTEGER_ARRAY;
static int* TERMINAL_ORIGINAL_ATTRIBUTES_INTERNAL = NUMBER_201_INTEGER_ARRAY;
static int* TERMINAL_WORKING_ATTRIBUTES_INTERNAL = NUMBER_202_INTEGER_ARRAY;
static int* TUI_INTERNAL = NUMBER_203_INTEGER_ARRAY;
static int* TUI_COUNT_INTERNAL = NUMBER_204_INTEGER_ARRAY;
static int* TUI_SIZE_INTERNAL = NUMBER_205_INTEGER_ARRAY;

/** The x window system. */
static int* X_WINDOW_SYSTEM_DISPLAY_NAME_INTERNAL = NUMBER_300_INTEGER_ARRAY;
static int* X_WINDOW_SYSTEM_DISPLAY_INTERNAL = NUMBER_301_INTEGER_ARRAY;
static int* X_WINDOW_SYSTEM_SCREEN_INTERNAL = NUMBER_302_INTEGER_ARRAY;
static int* X_WINDOW_SYSTEM_SCREEN_NUMBER_INTERNAL = NUMBER_303_INTEGER_ARRAY;
static int* X_WINDOW_SYSTEM_BACKGROUND_INTERNAL = NUMBER_304_INTEGER_ARRAY;
static int* X_WINDOW_SYSTEM_FOREGROUND_INTERNAL = NUMBER_305_INTEGER_ARRAY;
static int* X_WINDOW_SYSTEM_ROOT_WINDOW_INTERNAL = NUMBER_306_INTEGER_ARRAY;
static int* X_WINDOW_SYSTEM_COLOUR_MAP_INTERNAL = NUMBER_307_INTEGER_ARRAY;
static int* X_WINDOW_SYSTEM_GRAPHIC_CONTEXT_VALUE_MASK_INTERNAL = NUMBER_308_INTEGER_ARRAY;
static int* X_WINDOW_SYSTEM_GRAPHIC_CONTEXT_VALUES_INTERNAL = NUMBER_309_INTEGER_ARRAY;
static int* X_WINDOW_SYSTEM_GRAPHIC_CONTEXT_INTERNAL = NUMBER_310_INTEGER_ARRAY;
static int* X_WINDOW_SYSTEM_GRAPHIC_CONTEXT_MENU_INTERNAL = NUMBER_311_INTEGER_ARRAY;
static int* X_WINDOW_SYSTEM_GRAPHIC_CONTEXT_MENU_BORDER_TOP_INTERNAL = NUMBER_312_INTEGER_ARRAY;
static int* X_WINDOW_SYSTEM_GRAPHIC_CONTEXT_MENU_BORDER_BOTTOM_INTERNAL = NUMBER_313_INTEGER_ARRAY;
static int* X_WINDOW_SYSTEM_GRAPHIC_CONTEXT_MENU_FONT_INTERNAL = NUMBER_314_INTEGER_ARRAY;
static int* X_WINDOW_SYSTEM_FONT_NAME_INTERNAL = NUMBER_315_INTEGER_ARRAY;
static int* X_WINDOW_SYSTEM_FONT_INTERNAL = NUMBER_316_INTEGER_ARRAY;
static int* X_WINDOW_SYSTEM_WINDOW_INTERNAL = NUMBER_317_INTEGER_ARRAY;
static int* X_WINDOW_SYSTEM_WINDOW_MENU_BORDER_BOTTOM_GC_INTERNAL = NUMBER_318_INTEGER_ARRAY;
