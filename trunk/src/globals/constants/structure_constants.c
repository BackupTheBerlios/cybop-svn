 ...
 *
 * @version $Revision: 1.31 $ $Date: 2006-12-29 10:44:39 $ $Author: christian $
...
static int* SERVER_SOCKET_MUTEX_INTERNAL = NUMBER_4_INTEGER_ARRAY;
static int* SERVER_SOCKET_STYLE_INTERNAL = NUMBER_5_INTEGER_ARRAY;
static int* SERVER_SOCKET_STYLE_COUNT_INTERNAL = NUMBER_6_INTEGER_ARRAY;
static int* SERVER_SOCKET_COMMANDS_INTERNAL = NUMBER_7_INTEGER_ARRAY;
static int* SERVER_SOCKET_COMMANDS_COUNT_INTERNAL = NUMBER_8_INTEGER_ARRAY;
static int* SERVER_SOCKET_CHARACTER_BUFFER_INTERNAL = NUMBER_9_INTEGER_ARRAY;
static int* SERVER_SOCKET_CHARACTER_BUFFER_COUNT_INTERNAL = NUMBER_10_INTEGER_ARRAY;
static int* SERVER_SOCKET_CHARACTER_BUFFER_SIZE_INTERNAL = NUMBER_11_INTEGER_ARRAY;
