...
static const int X_WINDOW_SYSTEM_GRAPHIC_CONTEXT_MENU_INTERNAL_ARRAY[] = {38};
static const int* X_WINDOW_SYSTEM_GRAPHIC_CONTEXT_MENU_INTERNAL = X_WINDOW_SYSTEM_GRAPHIC_CONTEXT_MENU_INTERNAL_ARRAY;

static const int X_WINDOW_SYSTEM_GRAPHIC_CONTEXT_MENU_BORDER_TOP_INTERNAL_ARRAY[] = {39};
static const int* X_WINDOW_SYSTEM_GRAPHIC_CONTEXT_MENU_BORDER_TOP_INTERNAL = X_WINDOW_SYSTEM_GRAPHIC_CONTEXT_MENU_BORDER_TOP_INTERNAL_ARRAY;

static const int X_WINDOW_SYSTEM_GRAPHIC_CONTEXT_MENU_BORDER_BOTTOM_INTERNAL_ARRAY[] = {40};
static const int* X_WINDOW_SYSTEM_GRAPHIC_CONTEXT_MENU_BORDER_BOTTOM_INTERNAL = X_WINDOW_SYSTEM_GRAPHIC_CONTEXT_MENU_BORDER_BOTTOM_INTERNAL_ARRAY;

static const int X_WINDOW_SYSTEM_GRAPHIC_CONTEXT_MENU_FONT_INTERNAL_ARRAY[] = {41};
static const int* X_WINDOW_SYSTEM_GRAPHIC_CONTEXT_MENU_FONT_INTERNAL = X_WINDOW_SYSTEM_GRAPHIC_CONTEXT_MENU_FONT_INTERNAL_ARRAY;

static const int X_WINDOW_SYSTEM_FONT_NAME_INTERNAL_ARRAY[] = {42};
