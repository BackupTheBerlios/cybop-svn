 ...
 *
 * @version $Revision: 1.24 $ $Date: 2006-06-17 10:32:38 $ $Author: christian $
...
/** The terminal. */
static int* TERMINAL_FILE_DESCRIPTOR_INTERNAL = NUMBER_100_INTEGER_ARRAY;
static int* TERMINAL_ORIGINAL_ATTRIBUTES_INTERNAL = NUMBER_101_INTEGER_ARRAY;
static int* TERMINAL_WORKING_ATTRIBUTES_INTERNAL = NUMBER_102_INTEGER_ARRAY;
static int* TERMINAL_MUTEX_INTERNAL = NUMBER_103_INTEGER_ARRAY;
static int* TUI_INTERNAL = NUMBER_110_INTEGER_ARRAY;
static int* TUI_COUNT_INTERNAL = NUMBER_111_INTEGER_ARRAY;
static int* TUI_SIZE_INTERNAL = NUMBER_112_INTEGER_ARRAY;
