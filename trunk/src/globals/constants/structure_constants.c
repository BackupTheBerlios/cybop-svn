...
static int* TCP_CLIENT_SOCKETS_INTERNAL = NUMBER_350_INTEGER_ARRAY;
static int* TCP_CLIENT_SOCKETS_COUNT_INTERNAL = NUMBER_351_INTEGER_ARRAY;
static int* TCP_CLIENT_SOCKETS_SIZE_INTERNAL = NUMBER_352_INTEGER_ARRAY;

/** The signal identifications. */
static int* TCP_CLIENT_SOCKET_SIGNAL_IDS_INTERNAL = NUMBER_360_INTEGER_ARRAY;
static int* TCP_CLIENT_SOCKET_SIGNAL_IDS_COUNT_INTERNAL = NUMBER_361_INTEGER_ARRAY;
static int* TCP_CLIENT_SOCKET_SIGNAL_IDS_SIZE_INTERNAL = NUMBER_362_INTEGER_ARRAY;

/** The unix socket. */
static int* UNIX_SOCKET_INTERNAL = NUMBER_390_INTEGER_ARRAY;
static int* UNIX_SOCKET_FILENAME_INTERNAL = NUMBER_391_INTEGER_ARRAY;
static int* UNIX_SOCKET_MUTEX_INTERNAL = NUMBER_392_INTEGER_ARRAY;
