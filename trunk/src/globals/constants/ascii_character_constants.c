 ...
 *
 * @version $Revision: 1.1 $ $Date: 2006-02-09 02:22:58 $ $Author: christian $
 ...
 */
static char NULL_CONTROL_ASCII_CHARACTER_ARRAY[] = {0x00};
...
static char REVERSE_SOLIDUS_ASCII_CHARACTER_ARRAY[] = {0x5C};
...
static char RIGHT_SQUARE_BRACKET_ASCII_CHARACTER_ARRAY[] = {0x5D};
