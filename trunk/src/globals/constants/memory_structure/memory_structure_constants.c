...
/** The linux console. */
static int* LINUX_CONSOLE_INPUT_FILE_DESCRIPTOR_INTERNAL = NUMBER_100_INTEGER_ARRAY;
static int* LINUX_CONSOLE_OUTPUT_FILE_DESCRIPTOR_INTERNAL = NUMBER_101_INTEGER_ARRAY;
static int* LINUX_CONSOLE_ORIGINAL_ATTRIBUTES_INTERNAL = NUMBER_105_INTEGER_ARRAY;
static int* LINUX_CONSOLE_WORKING_ATTRIBUTES_INTERNAL = NUMBER_106_INTEGER_ARRAY;
static int* LINUX_CONSOLE_MUTEX_INTERNAL = NUMBER_110_INTEGER_ARRAY;
static int* LINUX_CONSOLE_INTERNAL = NUMBER_120_INTEGER_ARRAY;
static int* LINUX_CONSOLE_COUNT_INTERNAL = NUMBER_121_INTEGER_ARRAY;
static int* LINUX_CONSOLE_SIZE_INTERNAL = NUMBER_122_INTEGER_ARRAY;
