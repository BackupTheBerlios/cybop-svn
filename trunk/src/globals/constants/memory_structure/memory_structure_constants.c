...
static int* SOCKET_MODEL_INTERNAL = NUMBER_10_INTEGER_ARRAY;
static int* SOCKET_MODEL_COUNT_INTERNAL = NUMBER_11_INTEGER_ARRAY;
static int* SOCKET_MODEL_SIZE_INTERNAL = NUMBER_12_INTEGER_ARRAY;
static int* SOCKET_DETAILS_INTERNAL = NUMBER_13_INTEGER_ARRAY;
static int* SOCKET_DETAILS_COUNT_INTERNAL = NUMBER_14_INTEGER_ARRAY;
static int* SOCKET_DETAILS_SIZE_INTERNAL = NUMBER_15_INTEGER_ARRAY;
static int* SOCKET_COMMANDS_INTERNAL = NUMBER_20_INTEGER_ARRAY;
static int* SOCKET_COMMANDS_COUNT_INTERNAL = NUMBER_21_INTEGER_ARRAY;
static int* SOCKET_LANGUAGE_INTERNAL = NUMBER_22_INTEGER_ARRAY;
static int* SOCKET_LANGUAGE_COUNT_INTERNAL = NUMBER_23_INTEGER_ARRAY;
static int* SOCKET_STYLE_INTERNAL = NUMBER_24_INTEGER_ARRAY;
static int* SOCKET_STYLE_COUNT_INTERNAL = NUMBER_25_INTEGER_ARRAY;
static int* SOCKET_CHARACTER_BUFFER_INTERNAL = NUMBER_30_INTEGER_ARRAY;
static int* SOCKET_CHARACTER_BUFFER_COUNT_INTERNAL = NUMBER_31_INTEGER_ARRAY;
static int* SOCKET_CHARACTER_BUFFER_SIZE_INTERNAL = NUMBER_32_INTEGER_ARRAY;
static int* SOCKET_COMMUNICATION_PARTNER_INTERNAL = NUMBER_40_INTEGER_ARRAY;
static int* SOCKET_COMMUNICATION_PARTNER_ADDRESS_INTERNAL = NUMBER_41_INTEGER_ARRAY;
static int* SOCKET_COMMUNICATION_PARTNER_ADDRESS_SIZE_INTERNAL = NUMBER_42_INTEGER_ARRAY;
