 ...
 *
 * @version $Revision: 1.6 $ $Date: 2007-08-27 07:07:37 $ $Author: christian $
...
static int* SOCKET_CHARACTER_BUFFER_INTERNAL = NUMBER_17_INTEGER_ARRAY;
static int* SOCKET_CHARACTER_BUFFER_COUNT_INTERNAL = NUMBER_18_INTEGER_ARRAY;
static int* SOCKET_CHARACTER_BUFFER_SIZE_INTERNAL = NUMBER_19_INTEGER_ARRAY;
static int* SOCKET_COMMUNICATION_PARTNER_INTERNAL = NUMBER_20_INTEGER_ARRAY;
static int* SOCKET_COMMUNICATION_PARTNER_ADDRESS_INTERNAL = NUMBER_21_INTEGER_ARRAY;
static int* SOCKET_COMMUNICATION_PARTNER_ADDRESS_SIZE_INTERNAL = NUMBER_22_INTEGER_ARRAY;
