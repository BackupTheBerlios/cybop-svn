...
static int* SOCKET_STYLE_INTERNAL = NUMBER_5_INTEGER_ARRAY;
static int* SOCKET_STYLE_COUNT_INTERNAL = NUMBER_6_INTEGER_ARRAY;
static int* SOCKET_COMMANDS_INTERNAL = NUMBER_7_INTEGER_ARRAY;
static int* SOCKET_COMMANDS_COUNT_INTERNAL = NUMBER_8_INTEGER_ARRAY;
