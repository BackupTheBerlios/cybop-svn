...
#ifndef LCID_LANGUAGE_CONSTANTS_SOURCE
#define LCID_LANGUAGE_CONSTANTS_SOURCE
...
static int* ENGLISH_UNITED_KINGDOM_LANGUAGE_IDENTIFICATION = NUMBER_0_INTEGER_ARRAY;
...
/* LCID_LANGUAGE_CONSTANTS_SOURCE */
#endif
