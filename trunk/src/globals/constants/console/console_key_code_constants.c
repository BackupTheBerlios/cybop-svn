/*
 * $RCSfile: console_key_code_constants.c,v $
 *
...
#ifndef CONSOLE_KEY_CODE_CONSTANTS_SOURCE
#define CONSOLE_KEY_CODE_CONSTANTS_SOURCE
...
/* CONSOLE_KEY_CODE_CONSTANTS_SOURCE */
#endif
