    ...
    if (p9 != *NULL_POINTER) {
        ...
        if (p8 != *NULL_POINTER) {
            ...
            *irq = *NUMBER_0_INTEGER;
            ...
            log_terminated_message((void*) ERROR_LOG_LEVEL, (void*) L"Could not check cyboi service interrupt. The cyboi service interrupt request flag is null.");
        }

    } else {

        log_terminated_message((void*) ERROR_LOG_LEVEL, (void*) L"Could not check cyboi service interrupt. The cyboi service mutex is null.");
    }
}
*/
