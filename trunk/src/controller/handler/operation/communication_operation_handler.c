...
void handle_communication_operation(void* p0, void* p1, void* p2, void* p3, void* p4, void* p5, void* p6,
    ...
    if (*r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
        ...
        compare_equal_array(p16, p10, p11, (void*) RECEIVE_COMMUNICATION_OPERATION_CYBOL_MODEL, (void*) RECEIVE_COMMUNICATION_OPERATION_CYBOL_MODEL_COUNT, (void*) WIDE_CHARACTER_PRIMITIVE_MEMORY_ABSTRACTION);
    ...
    if (*r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
        ...
        compare_equal_array(p16, p10, p11, (void*) SEND_COMMUNICATION_OPERATION_CYBOL_MODEL, (void*) SEND_COMMUNICATION_OPERATION_CYBOL_MODEL_COUNT, (void*) WIDE_CHARACTER_PRIMITIVE_MEMORY_ABSTRACTION);
...
//??            send_message(p12, p13, p0, p1, p2, p3, p4, p5, p6, *((int**) p15));
    ...
    if (*r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
        ...
        compare_equal_array(p16, p10, p11, (void*) SENSE_COMMUNICATION_OPERATION_CYBOL_MODEL, (void*) SENSE_COMMUNICATION_OPERATION_CYBOL_MODEL_COUNT, (void*) WIDE_CHARACTER_PRIMITIVE_MEMORY_ABSTRACTION);
