 ...
 *
 * @version $RCSfile: arithmetic_operation_handler.c,v $ $Revision: 1.4 $ $Date: 2008-09-06 23:17:20 $ $Author: christian $
...
void handle_arithmetic_operation(void* p0, void* p1, void* p2, void* p3, void* p4, void* p5, void* p6,
    ...
    if (*r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
        ...
        compare_arrays(p10, p11, (void*) ADD_MODEL, (void*) ADD_MODEL_COUNT, p16, (void*) WIDE_CHARACTER_ARRAY_MEMORY_ABSTRACTION);
