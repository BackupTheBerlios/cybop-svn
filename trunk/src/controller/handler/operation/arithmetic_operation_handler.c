...
void handle_arithmetic_operation(void* p0, void* p1, void* p2, void* p3, void* p4, void* p5, void* p6,
    ...
    if (*r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
        ...
        compare_equal_array(p16, p10, p11, (void*) ADD_ARITHMETIC_OPERATION_CYBOL_MODEL, (void*) ADD_ARITHMETIC_OPERATION_CYBOL_MODEL_COUNT, (void*) WIDE_CHARACTER_PRIMITIVE_MEMORY_ABSTRACTION);
    ...
    if (*r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
        ...
        compare_equal_array(p16, p10, p11, (void*) DIVIDE_ARITHMETIC_OPERATION_CYBOL_MODEL, (void*) DIVIDE_ARITHMETIC_OPERATION_CYBOL_MODEL_COUNT, (void*) WIDE_CHARACTER_PRIMITIVE_MEMORY_ABSTRACTION);
...
//??            calculate_division(p12, p13, p1, p2, p3);
    ...
    if (*r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
        ...
        compare_equal_array(p16, p10, p11, (void*) MULTIPLY_ARITHMETIC_OPERATION_CYBOL_MODEL, (void*) MULTIPLY_ARITHMETIC_OPERATION_CYBOL_MODEL_COUNT, (void*) WIDE_CHARACTER_PRIMITIVE_MEMORY_ABSTRACTION);
...
//??            calculate_multiplication(p12, p13, p1, p2, p3);
    ...
    if (*r == *NUMBER_0_INTEGER_MEMORY_MODEL) {
        ...
        compare_equal_array(p16, p10, p11, (void*) SUBTRACT_ARITHMETIC_OPERATION_CYBOL_MODEL, (void*) SUBTRACT_ARITHMETIC_OPERATION_CYBOL_MODEL_COUNT, (void*) WIDE_CHARACTER_PRIMITIVE_MEMORY_ABSTRACTION);
