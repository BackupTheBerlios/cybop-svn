...
void startup_internal_memory(void* p0, void* p1, void* p2, void* p3, void* p4, void* p5, void* p6,
    ...
    set(p0, (void*) KNOWLEDGE_MEMORY_INTERNAL_MEMORY_MEMORY_NAME, p1, (void*) POINTER_MEMORY_ABSTRACTION);
    set(p0, (void*) KNOWLEDGE_MEMORY_COUNT_INTERNAL_MEMORY_MEMORY_NAME, p2, (void*) POINTER_MEMORY_ABSTRACTION);
    set(p0, (void*) KNOWLEDGE_MEMORY_SIZE_INTERNAL_MEMORY_MEMORY_NAME, p3, (void*) POINTER_MEMORY_ABSTRACTION);

    // Set signal memory internals.
    set(p0, (void*) SIGNAL_MEMORY_INTERNAL_MEMORY_MEMORY_NAME, p4, (void*) POINTER_MEMORY_ABSTRACTION);
    set(p0, (void*) SIGNAL_MEMORY_COUNT_INTERNAL_MEMORY_MEMORY_NAME, p5, (void*) POINTER_MEMORY_ABSTRACTION);
    set(p0, (void*) SIGNAL_MEMORY_SIZE_INTERNAL_MEMORY_MEMORY_NAME, p6, (void*) POINTER_MEMORY_ABSTRACTION);

    // Set signal memory interrupt request flag.
    set(p0, (void*) SIGNAL_MEMORY_INTERRUPT_REQUEST_INTERNAL_MEMORY_MEMORY_NAME, p7, (void*) POINTER_MEMORY_ABSTRACTION);
    // Set signal memory mutex.
    set(p0, (void*) SIGNAL_MEMORY_MUTEX_INTERNAL_MEMORY_MEMORY_NAME, p8, (void*) POINTER_MEMORY_ABSTRACTION);
    // Set signal memory sleep time.
    set(p0, (void*) SIGNAL_MEMORY_SLEEP_TIME_INTERNAL_MEMORY_MEMORY_NAME, p9, (void*) POINTER_MEMORY_ABSTRACTION);

    // Set gnu/linux console interrupt request flag.
    set(p0, (void*) GNU_LINUX_CONSOLE_INTERRUPT_REQUEST_INTERNAL_MEMORY_MEMORY_NAME, p10, (void*) POINTER_MEMORY_ABSTRACTION);
    // Set gnu/linux console mutex.
    set(p0, (void*) GNU_LINUX_CONSOLE_MUTEX_INTERNAL_MEMORY_MEMORY_NAME, p11, (void*) POINTER_MEMORY_ABSTRACTION);
    // Set gnu/linux console sleep time.
    set(p0, (void*) GNU_LINUX_CONSOLE_SLEEP_TIME_INTERNAL_MEMORY_MEMORY_NAME, p12, (void*) POINTER_MEMORY_ABSTRACTION);

    // Set x window system interrupt request flag.
    set(p0, (void*) X_WINDOW_SYSTEM_INTERRUPT_REQUEST_INTERNAL_MEMORY_MEMORY_NAME, p13, (void*) POINTER_MEMORY_ABSTRACTION);
    // Set x window system mutex.
    set(p0, (void*) X_WINDOW_SYSTEM_MUTEX_INTERNAL_MEMORY_MEMORY_NAME, p14, (void*) POINTER_MEMORY_ABSTRACTION);
    // Set x window system sleep time.
    set(p0, (void*) X_WINDOW_SYSTEM_SLEEP_TIME_INTERNAL_MEMORY_MEMORY_NAME, p15, (void*) POINTER_MEMORY_ABSTRACTION);
