...
static const int INTERNALS_STARTUP_CHANNEL_ARRAY[] = {0};
static const int* INTERNALS_STARTUP_CHANNEL = INTERNALS_STARTUP_CHANNEL_ARRAY;

static const int INTERNALS_STARTUP_CHANNEL_COUNT_ARRAY[] = {1};
static const int* INTERNALS_STARTUP_CHANNEL_COUNT = INTERNALS_STARTUP_CHANNEL_COUNT_ARRAY;

static const int INTERNALS_STARTUP_CHANNEL_SIZE_ARRAY[] = {2};
static const int* INTERNALS_STARTUP_CHANNEL_SIZE = INTERNALS_STARTUP_CHANNEL_SIZE_ARRAY;

static const int INTERNALS_STARTUP_ABSTRACTION_ARRAY[] = {3};
static const int* INTERNALS_STARTUP_ABSTRACTION = INTERNALS_STARTUP_ABSTRACTION_ARRAY;

static const int INTERNALS_STARTUP_ABSTRACTION_COUNT_ARRAY[] = {4};
static const int* INTERNALS_STARTUP_ABSTRACTION_COUNT = INTERNALS_STARTUP_ABSTRACTION_COUNT_ARRAY;

static const int INTERNALS_STARTUP_ABSTRACTION_SIZE_ARRAY[] = {5};
static const int* INTERNALS_STARTUP_ABSTRACTION_SIZE = INTERNALS_STARTUP_ABSTRACTION_SIZE_ARRAY;

static const int INTERNALS_STARTUP_MODEL_ARRAY[] = {6};
static const int* INTERNALS_STARTUP_MODEL = INTERNALS_STARTUP_MODEL_ARRAY;

static const int INTERNALS_STARTUP_MODEL_COUNT_ARRAY[] = {7};
static const int* INTERNALS_STARTUP_MODEL_COUNT = INTERNALS_STARTUP_MODEL_COUNT_ARRAY;

static const int INTERNALS_STARTUP_MODEL_SIZE_ARRAY[] = {8};
static const int* INTERNALS_STARTUP_MODEL_SIZE = INTERNALS_STARTUP_MODEL_SIZE_ARRAY;

/** The knowledge memory. */
static const int INTERNALS_KNOWLEDGE_MEMORY_ARRAY[] = {9};
static const int* INTERNALS_KNOWLEDGE_MEMORY = INTERNALS_KNOWLEDGE_MEMORY_ARRAY;

static const int INTERNALS_KNOWLEDGE_MEMORY_COUNT_ARRAY[] = {10};
static const int* INTERNALS_KNOWLEDGE_MEMORY_COUNT = INTERNALS_KNOWLEDGE_MEMORY_COUNT_ARRAY;

static const int INTERNALS_KNOWLEDGE_MEMORY_SIZE_ARRAY[] = {11};
static const int* INTERNALS_KNOWLEDGE_MEMORY_SIZE = INTERNALS_KNOWLEDGE_MEMORY_SIZE_ARRAY;

/** The signal memory. */
static const int INTERNALS_SIGNAL_MEMORY_ARRAY[] = {12};
static const int* INTERNALS_SIGNAL_MEMORY = INTERNALS_SIGNAL_MEMORY_ARRAY;

static const int INTERNALS_SIGNAL_MEMORY_COUNT_ARRAY[] = {13};
static const int* INTERNALS_SIGNAL_MEMORY_COUNT = INTERNALS_SIGNAL_MEMORY_COUNT_ARRAY;

static const int INTERNALS_SIGNAL_MEMORY_SIZE_ARRAY[] = {14};
static const int* INTERNALS_SIGNAL_MEMORY_SIZE = INTERNALS_SIGNAL_MEMORY_SIZE_ARRAY;

/** The tcp socket. */
static const int INTERNALS_TCPSOCKET_PORT_ARRAY[] = {15};
static const int* INTERNALS_TCPSOCKET_PORT = INTERNALS_TCPSOCKET_PORT_ARRAY;

static const int INTERNALS_TCPSOCKET_ACTIVE_ARRAY[] = {16};
static const int* INTERNALS_TCPSOCKET_ACTIVE = INTERNALS_TCPSOCKET_ACTIVE_ARRAY;

static const int INTERNALS_TCPSOCKET_SERVERSOCKETNUMBER_ARRAY[] = {17};
static const int* INTERNALS_TCPSOCKET_SERVERSOCKETNUMBER = INTERNALS_TCPSOCKET_SERVERSOCKETNUMBER_ARRAY;

/** The client socket. */
static const int INTERNALS_TCPSOCKET_CLIENTSOCKETNUMBER_ARRAY[] = {18};
static const int* INTERNALS_TCPSOCKET_CLIENTSOCKETNUMBER = INTERNALS_TCPSOCKET_CLIENTSOCKETNUMBER_ARRAY;

static const int INTERNALS_TCPSOCKET_CLIENTSOCKETNUMBER_COUNT_ARRAY[] = {19};
static const int* INTERNALS_TCPSOCKET_CLIENTSOCKETNUMBER_COUNT = INTERNALS_TCPSOCKET_CLIENTSOCKETNUMBER_COUNT_ARRAY;

static const int INTERNALS_TCPSOCKET_CLIENTSOCKETNUMBER_SIZE_ARRAY[] = {20};
static const int* INTERNALS_TCPSOCKET_CLIENTSOCKETNUMBER_SIZE = INTERNALS_TCPSOCKET_CLIENTSOCKETNUMBER_SIZE_ARRAY;

/** The main signal id. */
static const int INTERNALS_TCPSOCKET_MAINSIGNALID_ARRAY[] = {21};
static const int* INTERNALS_TCPSOCKET_MAINSIGNALID = INTERNALS_TCPSOCKET_MAINSIGNALID_ARRAY;

static const int INTERNALS_TCPSOCKET_MAINSIGNALID_COUNT_ARRAY[] = {22};
static const int* INTERNALS_TCPSOCKET_MAINSIGNALID_COUNT = INTERNALS_TCPSOCKET_MAINSIGNALID_COUNT_ARRAY;

static const int INTERNALS_TCPSOCKET_MAINSIGNALID_SIZE_ARRAY[] = {23};
static const int* INTERNALS_TCPSOCKET_MAINSIGNALID_SIZE = INTERNALS_TCPSOCKET_MAINSIGNALID_SIZE_ARRAY;
