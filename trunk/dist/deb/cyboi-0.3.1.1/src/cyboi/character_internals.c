 ...
 * @param p_valuecount
 */
void create_character_internal( void** pp_internalvalue ) {

    int count = 1;
    create_array( pp_internalvalue, (void*) &CHARACTER_ARRAY, (void*) &count );
}                                 
...
void destroy_character_internal( void** pp_internalvalue  ) {
    ...
    int count = 1;
    destroy_array( pp_internalvalue, (void*) &CHARACTER_ARRAY, (void*) &count );
}                                 

/**
 * set a character internal
 *
 * @param pp_internalvalue
 * @param p_valuecount
 */
void set_character_internal( void** pp_internalvalue, void* p_newvalue ) {
